...
$documents=School::ReadAllDocuments($_GET['userid']);
      ...
      foreach($types as $type)
      {
        ...
        {         
          ...
          <li class="nav-item" style="background: white; color: black;">
            <a class="nav-link" href="?album_type=<?php echo $type; ?>">
              <i class="fas fa-fw fa-chart-area"></i>
      ...
      <div class="container-fluid">
        ...
        <div class="card mb-3">
          <div class="card-header">
            <a href="document_upload_no.php?userid=<?php echo $_GET['userid'] ?>">Upload Documents</a> </div>
            <div>
              <?php
              if(count($documents)>0)
              {
                ...
                {
                  $documentdetails=School::ReadDocumentDetails($id);
                  ...
                  {
                    $userDetails=Module::ReadStudentDetailsp($_GET['userid']);
                  }
                  else
                  {
                    $userDetails=Module::ReadStaffDetails($_GET['userid']);
                  }
                  ...
                  <div  style="padding: 10px 10px 10px 10px; margin: 10px 10px 10px 10px; height: 200px; width: 250px; float: left">
                    ...
                    <div style="margin-top: -70px; background: black; width: 100%; padding: 3px 3px 3px 3px; height: 150px">
                      ...
                      <span  style="opacity: 1; color: red; font-weight: bolder; "><?php echo $documentdetails['document_type'] ?></span><br/><span  style="opacity: 1; color: white;"><?php echo $documentdetails['document_description'] ?></span>
                    </div>
                    <?php
                    if($document_user_id==$_GET['userid']||$_SESSION['user_category']=="admin")
                    {
                      ?>
                      <div style="margin-top: -90px; margin-left: 200px;  width: 30px; height: 30px;">
                        <a href="?deletebtn=yes&document_id=<?php echo $id; ?>&userid=<?php echo $_GET['userid']; ?>"><button style="width: 100%; height: 100%"><img src="../../images/icons/delete_icon.png" style="width: 100%"></button></a>
                      </div>
                      <?php
                    }
