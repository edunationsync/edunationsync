      ...
      <div class="row features_row">
        ...
        <div class="col-lg-3 feature_col">
          <a href="../"><div class="feature text-center trans_400">
            ...
            <h3 class="feature_title">Dashboard</h3>
            <div class="feature_text"><p>Carryout your own operations easily and flexibly<br/><br/><br/><br/></p></div>
          </div></a>
        </div>
        <?php 

        $Wards=Module::ReadParentWards($_SESSION['phone'],$_SESSION['email']);
        ...
        if(count($Wards)>0)
        {
          ...
          {
            $StudentDetails=Module::ReadStudentDetailsp($Ward);

            ?>            
            <!-- Features Item -->
            <div class="col-lg-3 feature_col">
              <div class="feature text-center trans_400">
                <div class="feature_icon"><img src="<?php echo 'data:image/jpeg;base64,'.$StudentDetails['passport'];?>" alt="" width="70px"></div>
                <h3 class="feature_title"><?php echo $StudentDetails['names']; ?></h3>
                <h4 class="feature_title"><?php echo $Ward; ?></h4>
                <div class="feature_text"><p>Student's Class <?php echo $StudentDetails['class']." @ ".$school_details['school_name'].", ".$school_details['school_address']; ?>.<br/>
                  <a href="./viewstudentprofile.php?id=<?php echo $Ward; ?>" target="_blank">Profile</a> | <a href="../finance/all_student_reciepts.php?reg_no=<?php echo $Ward; ?>" target="_blank">Fees</a> | <a href="../../portal/?reg_no=<?php echo $Ward; ?>" target="_blank">Results</a><br/></p></div>
              </div>
            </div>
            <?php
          }
      ...
      <div class="row copyright_row">
        <div class="col">
          <div class="copyright d-flex flex-lg-row flex-column align-items-center justify-content-start">
            <div class="cr_text">Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved Developed by <a href="https://gsdw.org.ng" target="_blank">Global Shining</a></div>
            <!--
