    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Easy Student Management</li>
        </ol>
        <!-- DataTables Example -->
        <div class="card mb-3">
          <div class="card-header">
            <a href="album_explorer.php?userid=<?php echo $_GET['userid'] ?>">Upload Pictures</a> | <a href="album.php?userid=<?php echo $_GET['userid'] ?>"> My Personal Album</a></div>
            <div>
              <?php
              if(count($albums)>0)
              {
                foreach($albums as $id)
                {
                  ...
                  <div  style="padding: 10px 10px 10px 10px; margin: 10px 10px 10px 10px; height: 200px; width: 250px; float: left">
                    <a href="./album_full_size.php?image_id=<?php echo $id; ?>"><center><img src="<?php echo $src; ?>" style="width: 200px; height: 130px; padding: 10px 10px 10px 10px"></center></a>
                    ...
                    <?php
                    if($album_user_id==$_GET['userid']||$_SESSION['user_category']=="admin")
                    {
                      ?>
                      <div style="margin-top: -90px; margin-left: 170px; width: 30px; height: 30px;">
                        <a href="?deletebtn=yes&delete_file_name=<?php echo $image_name; ?>&image_id=<?php echo $id; ?>"><button style="width: 100%; height: 100%"><img src="../../images/icons/delete_icon.png" style="width: 100%"></button></a>
                      </div>
                      <?php
                    }
