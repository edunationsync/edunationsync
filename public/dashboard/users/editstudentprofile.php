...
if(isset($_POST['btnUpdate']))
{
  ...
  if(Module::UpdateStudentp($id,$regid,$regno,$status,$names,$date_of_birth,$lga,$state,$country,$Class,$date_admitted,$session,$password,$guardian,$g_email,$g_phone,$date_graduated,$address))
  {    
  ...
  <div class="container">
    <div class="card card-register mx-auto mt-5"> 
      ...
      <div style="padding: 20px 20px 20px 20px">
        ...
        {
          ?>       
          <a href="allstudents.php?txtclassp=<?php echo $Class; ?>"   class="navi"  ><i class="fa fa-table"> All Students</i></a>    <br/><br/>  
          <a href="changestudentpassport.php?txtclassp=<?php echo $Class; ?>"   class="navi"  ><i class="fa fa-table"> Passport</i></a>
        ...
        <form  enctype="multipart/form-data" method="POST" action="">
          ...
          <div class="form-group">
            <div class="form-row">
              <div class="col-md-6">
                <div class="form-label-group">
                  <input type="text" id="regno" name="regno" class="form-control" placeholder="Register Number" required="required"   value="<?php echo $regno; ?>" readonly>
