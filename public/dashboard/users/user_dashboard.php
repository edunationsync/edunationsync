  ...
  <div class="features">
    <div class="container">
      ...
      <div class="row features_row">
        ...
        <!-- Features Item -->
        <div class="col-lg-3 feature_col">
          <a href="../innovation/index.php?userid=<?php echo $_GET['userid'] ?>"><div class="feature text-center trans_400">
            <div class="feature_icon"><img src="../images/team_2.jpg" alt="" width="70px"></div>
        ...
        <!-- Features Item -->
        <div class="col-lg-3 feature_col">
          <a href="albums.php?userid=<?php echo $_GET['userid'] ?>"><div class="feature text-center trans_400">
            <div class="feature_icon"><img src="../images/team_2.jpg" alt="" width="70px"></div>
        ...
        <!-- Features Item -->
        <div class="col-lg-3 feature_col">
          <a href="documents.php?userid=<?php echo $_GET['userid'] ?>"><div class="feature text-center trans_400">
            <div class="feature_icon"><img src="../images/team_2.jpg" alt="" width="70px"></div>
        ...
        <div class="col-lg-3 feature_col">
          <div class="feature text-center trans_400">
            ...
            <a href="../finance/index.php?userid=<?php echo $_GET['userid'] ?>">
              <div class="feature_icon"><img src="../../img/core-img/subject-logo.png" alt="" width="70px"></div>
