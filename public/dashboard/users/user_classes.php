  ...
  <div class="features">
    <div class="container">
      ...
      <div class="row features_row">
        ...
        $Classes=Module::ReadStaffAllocationClassesp($_SESSION['userid'],$_GET['txtsessionp'],$_GET['txttermp']);
        sort($Classes);
        if(count($Classes)>0)
        {
          $count=0;
          foreach($Classes as $Class)
          {
            ...
            <!-- Features Item -->
            <div class="col-lg-3 feature_col">
              <a href="./allstudents.php?txtclassp=<?php echo $Class; ?>"><div class="feature text-center trans_400">
                <div class="feature_icon"><img src="../images/team_2.jpg" alt="" width="70px"></div>
                <h3 class="feature_title"><?php echo $Class; ?></h3>
                <div class="feature_text"><p>Manage the students/students in <?php echo $Class; ?>.<br/><br/></p></div>
              </div></a>
            </div>
            <?php
          }
