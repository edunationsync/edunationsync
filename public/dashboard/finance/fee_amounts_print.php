...
<head> 
  ...
  <title>FEES & PAYMENT FOR <?php echo strtoupper($class); ?></title>
...
<body id="page-top">
  ...
  <header>
    <b>
    <div class="bheader"><center><img src="../../images/school/logo.png" width="100px"><br/><b ><hd><?php echo strtoupper($school_details['school_name']); ?></b><br/> SCHOOL FEES AMOUNTS REPORT <br/><?php echo strtoupper("Printed on ".date("D M Y")) ?></hd></center></div></b>
  </header>
          ...
          <table cellspacing="0" width="100%" style="font-size: 12px">
            ...
            <tbody>
              ...
              foreach($FeeAmounts as $FeeId)
              {
                ...
                <tr id="<?php echo $feeAmountDetails['id']; ?>" title="<?php echo $feeAmountDetails['class']; ?>">

                  
                  <td><center><?php echo $count; ?></center></td>

                  <td style="text-align: center;"   id="<?php echo $feeAmountDetails['id']; ?>class" title="<?php echo $feeAmountDetails['id']; ?> Class" ><?php echo $feeAmountDetails['class']; ?></td>

                  <td style="text-align: center;"   id="<?php echo $feeAmountDetails['id']; ?>session" title="<?php echo $feeAmountDetails['id'].' '.$feeAmountDetails['class']; ?>  Session" ><?php echo $feeAmountDetails['session']; ?></td>

                  <td style="text-align: center;"   id="<?php echo $feeAmountDetails['id']; ?>term" title="<?php echo $feeAmountDetails['id'].' '.$feeAmountDetails['class']; ?>  Term" ><?php echo $feeAmountDetails['term']; ?></td>

                  <td style="text-align: center;"  id="<?php echo $feeAmountDetails['id']; ?>reg_fee" title="<?php echo $feeAmountDetails['id'].' '.$feeAmountDetails['class']; ?> Registration Fee" ><?php if($feeAmountDetails['reg_fee']>0){echo $feeAmountDetails['reg_fee'];} ?></td>

                  <td style="text-align: center;"  id="<?php echo $feeAmountDetails['id']; ?>fee" title="<?php echo $feeAmountDetails['id'].' '.$feeAmountDetails['class']; ?> Fee" ><?php if($feeAmountDetails['fee']>0){echo $feeAmountDetails['fee'];} ?></td>

                  <td style="text-align: center;"  id="<?php echo $feeAmountDetails['id']; ?>book" title="<?php echo $feeAmountDetails['id'].' '.$feeAmountDetails['class']; ?> Book Cost"  ><?php if($feeAmountDetails['book']>0){echo $feeAmountDetails['book'];}  ?></td>

                  <td style="text-align: center;"  id="<?php echo $feeAmountDetails['id']; ?>lesson" title="<?php echo $feeAmountDetails['id'].' '.$feeAmountDetails['class']; ?> Lesson Fee" ><?php  if($feeAmountDetails['lesson']>0){echo $feeAmountDetails['lesson'];} ?></td>

                  <td style="text-align: center;"  id="<?php echo $feeAmountDetails['id']; ?>pta" title="<?php echo $feeAmountDetails['id'].' '.$feeAmountDetails['class']; ?> PTA Fee" ><?php  if($feeAmountDetails['pta']>0){echo $feeAmountDetails['pta'];} ?></td>
                  
                  <td style="text-align: center;"  id="<?php echo $feeAmountDetails['id']; ?>scard" title="<?php echo $feeAmountDetails['id'].' '.$feeAmountDetails['class']; ?> Scrtach Card" ><?php  if($feeAmountDetails['scard']>0){echo $feeAmountDetails['scard'];} ?></td>
