    	...
    	foreach($Fees as $Fee)
    	{
		    ...
		    <div class="card card-register mx-auto mt-5"> 
		      <div style="padding: 20px 20px 20px 20px;">
		      	...
		      	<center><h2 onclick="window.history.back()" style="font-size: 16px; font-weight: bolder"><?php echo $school_details['school_name']; ?></h2> <h3  style="font-size: 14px; font-weight: bolder"><?php echo $school_details['school_address']; ?></h3></center></div>
