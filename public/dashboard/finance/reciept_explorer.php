...
<body class="bg-dark">
  ...
  <div class="container">
    <div class="card card-register mx-auto mt-5"> 
      ...
      <div class="card-header">RECIEPT EXPLORATION FORM</div>
      <div class="card-header"><?php echo $msg; ?></div>
     
      <div class="card-body">
        <form  enctype="multipart/form-data" method="GET" action="all_student_reciepts.php">
          
          <div class="form-group">
            <div class="form-row">
              <input type="text" id="reg_no" name="reg_no" class="form-control" placeholder="Student">                    
            ...
            <div class="form-row">
              <div class="col-md-6">
                <div class="form-label-group"> 
                  <button type="submit" class="btn btn-primary btn-block" name="s" id="s" >Open Reciept</button>
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-label-group">
