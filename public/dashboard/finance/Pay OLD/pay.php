        ...
        <div class="block">
          ...
          <form>
            ...
            <table class="paymentForm">
              ...
              <tr><td colspan="4"><center><button onclick="payWithPaystack(document.getElementById('txtemail').value,document.getElementById('txtphone').value,document.getElementById('txtamount').value)">Pay</button></center></td></tr>
