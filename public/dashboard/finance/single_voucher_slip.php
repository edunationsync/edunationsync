...
<body>
	...
	<div style="float: left; padding: 5px 5px 5px 5px; height: 540px; width: 450px">
	    ...
	    <div class="card card-register mx-auto mt-5"> 
	      ...
	      <div class="card-header"><center><strong><?php echo strtoupper($voucherDetails['month']).", ".$voucherDetails['year']; ?> VOUCHER</strong></center></div>
	      <div><b style="font-size: 15px; font-weight: bolder; "><center><?php echo strtoupper($voucherDetails['ref']) ?></center></b>        		              		
