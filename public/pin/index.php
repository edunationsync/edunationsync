...
<head> 
  ...
  <title> <?php echo $schoolDetails['school_name']; ?> Scratch Card Dashboard</title>
  <link rel="icon" type="image/png" href="../images/school/favicon.png"/>
  ...
  <div id="wrapper">
    ...
    <ul class="sidebar navbar-nav">
      <li class="nav-item active">
        <a class="nav-link" href="?school_id=AAA">
      ...
      <li class="nav-item" style="border-bottom: 4px groove white">
        <a class="nav-link" href="my_pins/generate.php?school_id=AAA">
          <i class="fas fa-fw fa-home"></i>
          <span>Generate Pins</span></a>
      </li>
      <li class="nav-item" style="border-bottom: 4px groove white">
        <a class="nav-link" href="my_pins/available.php?school_id=AAA">
          <i class="fas fa-fw fa-home"></i>
          <span>Available Cards</span></a>
      </li>
      <li class="nav-item" style="border-bottom: 4px groove white">
        <a class="nav-link" href="my_pins/used.php?school_id=AAA">
          <i class="fas fa-fw fa-home"></i>
          <span>Used Cards</span></a>
      </li>
      <li class="nav-item" style="border-bottom: 4px groove white">
        <a class="nav-link" href="my_pins/index.php?school_id=AAA">
          <i class="fas fa-fw fa-home"></i>
