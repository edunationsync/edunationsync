...
//if(!(isset($Term)))
  ...
  $BestStudents=Module::ReadSessionAnalysis1stpositionsp($Session);
?>
  ...
  <div>
    ...
    <div>
      ...
      <div>
        ...
        <ol class="breadcrumb">
          <li class="breadcrumb-item">
            <a href="best_session_result_summary_print.php?sessionp=<?php echo $Session_s; ?>&termp=<?php echo $Term ?>&classp=<?php echo $Class; ?>" style="padding: 4px 4px 4px 4px; margin: 4px 4px 4px 4px; background: white; color: black" target="_blank">Print Session Summary</a> | <a href="best_session_result_summary_optimized.php?sessionp=<?php echo $Session_s; ?>&termp=<?php echo $Term ?>&classp=<?php echo $Class; ?>&subjectp=<?php echo $Subject; ?>" style="padding: 4px 4px 4px 4px; margin: 4px 4px 4px 4px; background: white; color: black" target="_blank">Print Best Session Summary Optimized</a> | <button <?php if ($_GET['btnTotalUpdater']!=="true"): ?>style="background: blue; color: white; padding: 4px 4px 4px 4px; margin: 4px 4px 4px 4px; "
              
            <?php else: ?>style="background: white; color: black; padding: 4px 4px 4px 4px; margin: 4px 4px 4px 4px; "
              
            <?php endif ?>><a href="session_result_summary.php?sessionp=<?php echo $Session_s; ?>&termp=<?php echo $Term ?>&classp=<?php echo $Class; ?>">Normal Summary</a></button>
          </li>
          <div style="padding-left: 25px">
      ...
      <div class="container-fluid"> 
        ...
        <div class="content" id="content" style="padding:20px 20px 20px 20px">
          <header>
            <b>
            <div class="bheader"><center ><b ><hd> SESSION BEST STUDENTS SUMMARY</hd></b><br/>
              <hd1>FOR <?php echo $Session; ?></center></div></b>
          </header>
            ...
            <tr>
              <td style="border:none">
                  <table cellspacing="0" width="100%">
                    ...
                    <thead>
                    <tr><td  width="40px"  valign="top">REG. NO.</td><td  valign="top" style="width: 300px">NAME</td><td  valign="top" style="width: 300px">CLASS</td><td width="5px" valign="top">1<sup>ST</sup> TERM TOT</td><td width="5px" valign="top">1<sup>ST</sup> TERM AVER</td><td width="5px" valign="top">1<sup>ST</sup> TERM POS</td>

                      <td width="5px" valign="top">2<sup>ND</sup> TERM TOT</td><td width="5px" valign="top">2<sup>ND</sup> TERM AVER</td><td width="5px" valign="top">2<sup>ND</sup> TERM POS</td>

                      <td width="5px" valign="top">3<sup>RD</sup> TERM TOT</td><td width="5px" valign="top">3<sup>RD</sup> TERM AVER</td><td width="5px" valign="top">3<sup>RD</sup> TERM POS</td>

                      <td width="5px" valign="top">TOTAL</td><td width="5px" valign="top">AVERAGE</td><td width="5px" valign="top">POSITION</td><td  width="70px" valign="top">GRADE</td></tr></thead>
                    <tbody>
                      <?php
                      $count=0;
                      ...
                      {
                        $count++;
                        $resAnalysis=Module::ReadStatisticalAnalysisIdDetails($ID);
                        ...
                        <tr>
                          ...
                          <td><center><?php echo $resAnalysis['class']; ?></center></td>

                          <td class="data"><?php echo round($resAnalysis['1st_term_total'],2); ?></td>
                          <td class="data"><?php echo $resAnalysis['1st_term_average']; ?></td>
                          <td class="data">                            
                          ...
                          <td class="data"><?php echo round($resAnalysis['2nd_term_total'],2); ?></td>
                          <td class="data"><?php echo $resAnalysis['2nd_term_average']; ?></td>
                          <td class="data">                            
                          ...
                          <td class="data"><?php echo round($resAnalysis['3rd_term_total'],2); ?></td>
                          <td class="data"><?php echo $resAnalysis['3rd_term_average']; ?></td>
                          <td class="data">                            
                          ...
                          <td class="data"><?php if($resAnalysis['position']>0){ echo $resAnalysis['position'];
