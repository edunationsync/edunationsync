...
<head> 
  ...
  <script type="text/javascript">
      ...
      function ProcessSessionSubjectClassPositions(sub,session,classs,subject)
        {
          var xmlhttp = new XMLHttpRequest();
          xmlhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200)
          ...
          xmlhttp.open("GET", "generate_session_subject_positions.php?session="+session+'&class='+classs+'&subject='+subject+'&sub='+sub , true);
          xmlhttp.send();
        }

      function ClearSessionSubjectClassPositions(sub,session,classs,subject)
        {
          var xmlhttp = new XMLHttpRequest();
          xmlhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200)
          ...
          xmlhttp.open("GET", "generate_session_subject_positions.php?session="+session+'&class='+classs+'&subject='+subject+'&sub='+sub+'&operation=clear_position' , true);
          xmlhttp.send();
        }


        function ProcessSessionPositions(sub,session,classs,subject)
        {
          var xmlhttp = new XMLHttpRequest();
          xmlhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200)
          ...
          xmlhttp.open("GET", "generate_session_subject_positions.php?session="+session+'&class='+classs+'&sub='+sub , true);
          xmlhttp.send();
        }

        function ClearSessionPositions(sub,session,classs)
        {
          var xmlhttp = new XMLHttpRequest();
          xmlhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200)
          ...
          xmlhttp.open("GET", "master_sheet/generate_positions.php?session="+session+'&operation=clear_position'+'&sub='+sub+'&class='+classs , true);
          xmlhttp.send();
        }
      ...
      <div>
        ...
        <ol class="breadcrumb">
          ...
          <div style="padding-left: 25px">
            <a href="../dashboard">Dashboard</a> | <a href="../dashboard/users/allstudents.php?txtclassp=<?php echo $Class; ?>" target="_blank">Students</a> | <a href="result/psychomotorp.php?classp=<?php echo $Class; ?>&sessionp=<?php echo $Session; ?>&termp=<?php echo $Term; ?>" target="_blank">Ratings</a> | <a href="positions.php?classp=<?php echo $Class; ?>&sessionp=<?php echo $Session; ?>&termp=<?php echo $Term; ?>" target="_blank">Positions</a> | <a href="master_sheet/master_sheetp.php?txtclass=<?php echo $Class; ?>&txtsession=<?php echo $Session; ?>&txtterm=<?php echo $Term; ?>" target="_blank">Master Sheet</a> | <a href="master_sheet/master_sheet_ca1.php?txtclass=<?php echo $Class; ?>&txtsession=<?php echo $Session; ?>&txtterm=<?php echo $Term; ?>">CA1 Master</a> | <a href="master_sheet/master_sheet_ca2.php?txtclass=<?php echo $Class; ?>&txtsession=<?php echo $Session; ?>&txtterm=<?php echo $Term; ?>">CA2 Master</a> | <a href="master_sheet/master_sheet_exam.php?txtclass=<?php echo $Class; ?>&txtsession=<?php echo $Session; ?>&txtterm=<?php echo $Term; ?>">Exam Master</a> | <a href="../portal/allresultsfull.php?prclass=<?php echo $Class; ?>&prsession=<?php echo $Session; ?>" target="_blank">Result Sheets</a> | <a href="portal/student_resultp.php?class=<?php echo $Class; ?>&session=<?php echo $Session; ?>&term=<?php echo $Term; ?>" target="_blank">Individual Updater</a> | <a href="result_summary.php?classp=<?php echo $Class; ?>&sessionp=<?php echo $Session; ?>&termp=<?php echo $Term; ?>" target="_blank">Term Summary</a> | <a href="session_result_summary.php?classp=<?php echo $Class; ?>&sessionp=<?php echo $Session; ?>" target="_blank">Session Summary</a> | <a href="session_term_errors.php?classp=<?php echo $Class; ?>&sessionp=<?php echo $Session; ?>" target="_blank">Session Term Errors</a> | <a href="session_subject_analysis.php?classp=<?php echo $Class; ?>&sessionp=<?php echo $Session; ?>" target="_blank">Subject Analysis</a>
          </div>
        </ol><!-- Breadcrumbs-->
        ...
        <ol class="breadcrumb">
          <div style="padding-left: 25px; background: black; padding: 10px 10px 10px 10px; font-size: 12px;">
            ...
            foreach($Classesss as $classes_s)
            {
              ...
              {
                ?>
                <a href="?sessionp=<?php echo $Session; ?>&termp=<?php echo $Term ?>&classp=<?php echo $classes_s; ?>&subjectp=<?php echo $Subject; ?>" style="padding: 4px 4px 4px 4px; margin: 4px 4px 4px 4px; background: white; color: black"><?php echo $classes_s; ?></a>
                <?php
              }
              else
              {
                ?>
                <a href="?sessionp=<?php echo $Session; ?>&termp=<?php echo $Term ?>&classp=<?php echo $classes_s; ?>&subjectp=<?php echo $Subject; ?>" style="padding: 4px 4px 4px 4px; margin: 4px 4px 4px 4px; background: black; color: white;"><?php echo $classes_s; ?></a>
                <?php                
              }
            }
        ...
        <ol class="breadcrumb">
          <div style="padding-left: 25px; background: black; padding: 10px 10px 10px 10px; font-size: 12px;">
            <?php
            $Subjects_s=Module::ReadClassSubjectsp($Class);

            foreach($Subjects_s as $Subject_s)
            {
              if($Subject_s ==$Subject)
              {
                ?>
                <a href="?sessionp=<?php echo $Session; ?>&termp=<?php echo $Term ?>&subjectp=<?php echo $Subject_s ?>&classp=<?php echo $Class; ?>" style="padding: 4px 4px 4px 4px; margin: 4px 4px 4px 4px; background: white; color: black"><?php echo $Subject_s; ?></a>
                <?php
              }
              else
              {
                ?>
                <a href="?sessionp=<?php echo $Session; ?>&termp=<?php echo $Term ?>&subjectp=<?php echo $Subject_s ?>&classp=<?php echo $Class; ?>" style="padding: 4px 4px 4px 4px; margin: 4px 4px 4px 4px; background: black; color: white;"><?php echo $Subject_s; ?></a>
                <?php                
              }
            }
            ?>
        ...
        <ol class="breadcrumb">
          <li class="breadcrumb-item">
            <a href="session_subject_analysis_print.php?sessionp=<?php echo $Session_s; ?>&termp=<?php echo $Term ?>&classp=<?php echo $Class; ?>&subjectp=<?php echo $Subject; ?>" style="padding: 4px 4px 4px 4px; margin: 4px 4px 4px 4px; background: white; color: black">Print Session Summary Summary</a> | <button <?php if ($_GET['btnTotalUpdater']!=="true"): ?>style="background: blue; color: white; padding: 4px 4px 4px 4px; margin: 4px 4px 4px 4px; "
              
            <?php else: ?>style="background: white; color: black; padding: 4px 4px 4px 4px; margin: 4px 4px 4px 4px; "
              
            <?php endif ?>><a href="session_subject_analysis.php?sessionp=<?php echo $Session; ?>&termp=<?php echo $Term ?>&classp=<?php echo $Class; ?>&subjectp=<?php echo $Subject; ?>">Normal Summary</a></button> | <button  <?php if ($_GET['btnTotalUpdater']=="true"): ?>style="background: blue; color: white; padding: 4px 4px 4px 4px; margin: 4px 4px 4px 4px; "
              
            <?php else: ?>style="background: white; color: black; padding: 4px 4px 4px 4px; margin: 4px 4px 4px 4px; "
              
            <?php endif ?>><a href="session_subject_analysis.php?sessionp=<?php echo $Session; ?>&classp=<?php echo $Class; ?>&subjectp=<?php echo $Subject; ?>&btnTotalUpdater=true" >Update Session Subjects' Result</a></button> | <button onclick="UpdateAnalysis('<?php echo $Class;?>','<?php echo $Session;?>','<?php echo $Term; ?>');">Update Analysis</button> | <button><a href="best_session_subject_analysis.php?sessionp=<?php echo $Session_s; ?>&termp=<?php echo $Term ?>&classp=<?php echo $Class; ?>&subjectp=<?php echo $Subject; ?>">Best Session Subject Summary</a></button>
          </li>
          <div style="padding-left: 25px">
            ...
            <table>
              <tr>
                <td style="padding: 10px 10px 10px 10px">
                  <?php
                  if(Module::IsNotSessionSubPositionUpdated('CA1',$Session,$Class,$Subject))
                  {
                    ?>
                    <span>CA1</span>
                    <button onclick="ProcessSessionSubjectClassPositions('CA1','<?php echo $Session; ?>','<?php echo $Class; ?>','<?php echo $Subject; ?>')">GENERATE</button>
                    <?php
                  }
                  else
                  {
                    ?><span>CA1</span>
                    <button onclick="ProcessSessionSubjectClassPositions('CA1','<?php echo $Session; ?>','<?php echo $Class; ?>','<?php echo $Subject; ?>')">UPDATE</button> <button onclick="ClearSessionSubjectClassPositions('CA1','<?php echo $Session; ?>','<?php echo $Class; ?>','<?php echo $Subject; ?>')">CEAR</button>
                    <?php
                  }
                  ?>
                </td>
                <td style="padding: 10px 10px 10px 10px">
                    <?php
                  if(Module::IsNotSessionSubPositionUpdated('CA2',$Session,$Class,$Subject))
                  {
                    ?>
                    <span>CA2</span>
                    <button onclick="ProcessSessionSubjectClassPositions('CA2','<?php echo $Session; ?>','<?php echo $Class; ?>','<?php echo $Subject; ?>')">GENERATE</button>
                    <?php
                  }
                  else
                  {
                    ?><span>CA2</span>
                    <button onclick="ProcessSessionSubjectClassPositions('CA2','<?php echo $Session; ?>','<?php echo $Class; ?>','<?php echo $Subject; ?>')">UPDATE</button> <button onclick="ClearSessionSubjectClassPositions('CA2','<?php echo $Session; ?>','<?php echo $Class; ?>','<?php echo $Subject; ?>')">CEAR</button>
                    <?php
                  }
                  ?>
                </td>
                <td style="padding: 10px 10px 10px 10px">
                    <?php
                  if(Module::IsNotSessionSubPositionUpdated('CA3',$Session,$Class,$Subject))
                  {
                    ?>
                    <span>CA3</span>
                    <button onclick="ProcessSessionSubjectClassPositions('CA3','<?php echo $Session; ?>','<?php echo $Class; ?>','<?php echo $Subject; ?>')">GENERATE</button>
                    <?php
                  }
                  else
                  {
                    ?><span>CA3</span>
                    <button onclick="ProcessSessionSubjectClassPositions('CA3','<?php echo $Session; ?>','<?php echo $Class; ?>','<?php echo $Subject; ?>')">UPDATE</button> <button onclick="ClearSessionSubjectClassPositions('CA3','<?php echo $Session; ?>','<?php echo $Class; ?>','<?php echo $Subject; ?>')">CEAR</button>
                    <?php
                  }
                  ?>
                </td>
                <td style="padding: 10px 10px 10px 10px">
                  ...
                  if(Module::IsNotSessionSubPositionUpdated('Exam',$Session,$Class,$Subject))
                  {
                    ?>
                    <span>Exam</span>
                    <button onclick="ProcessSessionSubjectClassPositions('Exam','<?php echo $Session; ?>','<?php echo $Class; ?>','<?php echo $Subject; ?>')">GENERATE</button>
                    <?php
                  }
                  else
                  {
                    ?><span>Exam</span>
                    <button onclick="ProcessSessionSubjectClassPositions('Exam','<?php echo $Session; ?>','<?php echo $Class; ?>','<?php echo $Subject; ?>')">UPDATE</button> <button onclick="ClearSessionSubjectClassPositions('Exam','<?php echo $Session; ?>','<?php echo $Class; ?>','<?php echo $Subject; ?>')">CEAR</button>
                    <?php
                  }
                ?>
              </td>
                <td style="padding: 10px 10px 10px 10px">
                  ...
                  if(Module::IsNotSessionSubPositionUpdated('Overall',$Session,$Class,$Subject))
                  {
                    ?>
                    <span>Overall</span>
                    <button onclick="ProcessSessionSubjectClassPositions('Overall','<?php echo $Session; ?>','<?php echo $Class; ?>','<?php echo $Subject; ?>')">GENERATE</button>
                    <?php
                  }
                  else
                  {
                    ?><span>Overall</span>
                    <button onclick="ProcessSessionSubjectClassPositions('Overall','<?php echo $Session; ?>','<?php echo $Class; ?>','<?php echo $Subject; ?>')">UPDATE</button> <button onclick="ClearSessionSubjectClassPositions('Overall','<?php echo $Session; ?>','<?php echo $Class; ?>','<?php echo $Subject; ?>')">CEAR</button>
                    <?php
                  }
                ?>
              </td>
                <td style="padding: 10px 10px 10px 10px">
                    <span>SUBJECT POSITIONS</span>
                    <a href="session_subject_positions.php?classp=<?php echo $Class; ?>&sessionp=<?php echo $Session; ?>"><button>UPDATE</button></a>
                </td>
              </tr>
            </table>
            ...
            <tr>
              <td style="border:none">
                  <table cellspacing="0" width="100%">
                    ...
                    <thead>
                      <tr>
                        <td  width="40px" valign="top">REG. NO.</td><td  valign="top" style="width: 300px">NAME</td>

                        <td width="5px" valign="top">CA1 TOT (30)</td><td width="5px" valign="top">CA1 AVR (100%)</td><td width="5px" valign="top">CA1 POS</td><td width="5px" valign="top">CA1 GR</td><td width="5px" valign="top">CA1 REM</td> 

                        <td width="5px" valign="top">CA2 TOT (30)</td><td width="5px" valign="top">CA2 AVR (100%)</td><td width="5px" valign="top">CA2 POS</td><td width="5px" valign="top">CA2 GR</td><td width="5px" valign="top">CA2 REM</td>

                        <td width="5px" valign="top">CA3 TOT (30)</td><td width="5px" valign="top">CA3 AVR (100%)</td><td width="5px" valign="top">CA3 POS</td><td width="5px" valign="top">CA3 GR</td><td width="5px" valign="top">CA3 REM</td>

                        <td width="5px" valign="top">EXAM TOT (210)</td><td width="5px" valign="top">EXAM AVR (100%)</td><td width="5px" valign="top">EXAM POS</td><td width="5px" valign="top">EXAM GR</td><td width="5px" valign="top">EXAM REM</td>

                        <td width="5px" valign="top">TOTAL (300)</td><td width="5px" valign="top">AVERAGE (100%)</td><td width="5px" valign="top">POSITION</td><td width="5px" valign="top">GRADE</td><td width="5px" valign="top">REMARK</td>
                      </tr>
                    </thead>
                    <tbody>
                      <?php
                      ...
                      foreach($Students as $RegNo)
                      {
                        ...
                        {
                          Analysis::ProcessSubjectResultAnalysisp($RegNo,$Class,$Session);
                        }

                        $resAnalysis=Analysis::ReadSessionSubjectResultAnalysisp($RegNo,$Subject,$Session);
                        //echo "[".$resAnalysis['total_average']."]";
                        ?>
                        ...
                        <tr>
                          ...
                          {
                            ?>
                            <td><a style="background:transparent; border:none;" href="../dashboard/users/editstudentprofile.php?id=<?php echo $RegNo; ?>" title="Modify Profile"><center><?php echo $RegNo; ?></center></a></td>
                        ...
                        ?>
                          ...
                          <td class="data" id="<?php echo $RegNo; ?>ca3T"><?php echo $resAnalysis['ca3_total']; ?></td>
