    ...
    <div>
      ...
      <div class="container-fluid"> 
        ...
        <div class="content" id="content" style="padding:20px 20px 20px 20px">
          <header>
            <b>
            <div class="bheader"><center ><img src="../images/school/logo.png" width="100px"/><br/><b ><hd> SESSION BEST STUDENTS SUMMARY</hd></b><br/>
            ...
            <tr>
              <td style="border:none">
                  <table cellspacing="0" width="100%">
                    ...
                    <thead>
                    <tr><td  width="40px"  valign="top">REG. NO.</td><td  valign="top" style="width: 300px">NAME</td><td  valign="top" style="width: 300px">CLASS</td>
                    ...
                    <tbody>
                      ...
                      foreach($BestStudents as $ID)
                      {
                        ...
                        <tr>
                          ...
                          <td class="data"><center><?php echo $resAnalysis['total']; ?></center></td>
                          <td class="data"><center><?php echo $resAnalysis['average']; ?></center></td>
                          <td class="data"><center><?php if($resAnalysis['position']>0){ echo $resAnalysis['position'];
                            ...
                            ?></center></td>             
                          <td class="data" id="<?php echo $RegNo; ?>Grade"><center><?php echo $resAnalysis['grade'];  ?></center></td>
                          <td class="data" id="<?php echo $RegNo; ?>Remark" contenteditable="true" onkeydown="if(event.keyCode==9){UpdateRemarkManually('<?php echo $RegNo;?>','<?php echo $Session;?>','<?php echo $Term;?>','<?php echo $Class;?>',this.innerHTML)}"><center><?php echo $resAnalysis['remark'];  ?></center></td>
                        </tr>
