...
<head> 
  ...
  <title>Analysis Sheet <?php echo $Class.' '.$Session.' '.$Term; ?>Term CA1</title>
  <link rel="icon" type="image/png" href="../images/school/favicon.png"/>
              ...
              <td style="border:none">
                <header>
                  ...
                  <div class="bheader"><center ><b ><hd><?php echo strtoupper($school_details['school_name']); ?></hd></b><br/>
                    <hd1><?php echo $Session; ?> <?php echo strtoupper($Term); ?> TERM <br/> RESULT ANALYSIS SHEET FOR <?php echo strtoupper("$Class");  ?> <br/><?php echo strtoupper("$Subject");  ?> CA1</hd1></center></div></b>
                </header>
