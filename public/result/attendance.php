...
<body id="page-top">
  ...
  <div id="wrapper">
      ...
      <div class="container-fluid">
        ...
        <div class="content" id="content" style="padding:20px 20px 20px 20px; width:auto;">
          <header>
            <b>
        ...
        foreach($Students as $RegNo)
        {
          ...
          else
          {
            ...
            ?>
              ...
              <td style="display:none"><input type="text" value="<?php echo $attentiveness;  ?>"  id="<?php echo $count;  ?>attentiveness"  onkeyup="saverating('<?php echo $RegNo; ?>',
                 '<?php echo $Session; ?>',
                 '<?php echo $Term; ?>',
                 document.getElementById('<?php echo $count."attendance"; ?>').value,
                 document.getElementById('<?php echo $count."attentiveness"; ?>').value,
                ...
                <td style="display:none"><input type="text" value="<?php echo $neatness;  ?>" id="<?php echo $count;  ?>neatness" onkeyup="saverating('<?php echo $RegNo; ?>',
                 '<?php echo $Session; ?>',
                 '<?php echo $Term; ?>',
                 document.getElementById('<?php echo $count."attendance"; ?>').value,
                 document.getElementById('<?php echo $count."attentiveness"; ?>').value,
              ...
              <td style="display:none"><input type="text" id="<?php echo $count;  ?>politeness" value="<?php echo $politeness;  ?>"  onkeyup="saverating('<?php echo $RegNo; ?>',
                 '<?php echo $Session; ?>',
                 '<?php echo $Term; ?>',
                 document.getElementById('<?php echo $count."attendance"; ?>').value,
                 document.getElementById('<?php echo $count."attentiveness"; ?>').value,
              ...
              <td style="display:none"><input value="<?php echo $relationship; ?>" type="text" id="<?php echo $count;  ?>relationship" onkeyup="saverating('<?php echo $RegNo; ?>',
                 '<?php echo $Session; ?>',
                 '<?php echo $Term; ?>',
                 document.getElementById('<?php echo $count."attendance"; ?>').value,
                 document.getElementById('<?php echo $count."attentiveness"; ?>').value,
              ...
              <td style="display:none"><input value="<?php echo $honesty; ?>" type="text" id="<?php echo $count;  ?>honesty" onkeyup="saverating('<?php echo $RegNo; ?>',
                 '<?php echo $Session; ?>',
                 '<?php echo $Term; ?>',
                 document.getElementById('<?php echo $count."attendance"; ?>').value,
                 document.getElementById('<?php echo $count."attentiveness"; ?>').value,
