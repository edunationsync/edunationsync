  ...
  <div id="wrapper">
      ...
      <div class="container-fluid"> 
        ...
        <div class="content" id="content" style="padding:20px 20px 20px 20px">
          <header>
            <b>
            <div class="bheader"><center ><img src="../images/school/logo.png" width="100px"><br/><b ><hd><?php echo strtoupper($school_details['school_name']); ?></hd></b><br/>OPTIMIZED RESULT SUMMARY SHEET <BR/>
                <?php echo $Session; ?> <?php echo strtoupper($Term); ?> TERM FOR <?php echo strtoupper("$Class");  ?> </center></div></b>
          </header>
