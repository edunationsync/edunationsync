...
<head> 
  ...
  <title>Ratings for <?php echo $Class.' Ratings for '.$Term.' Term '.$Session; ?></title>
  <link rel="icon" type="image/png" href="../images/school/favicon.png"/>
  ...
  <script type="text/javascript">
      ...
      {  
        ...
        for (var i = students.length - 1; i >= 0; i--) {
          document.getElementById(students[i]+"attendance").contentEditable="true";
...
<body id="page-top">
  ...
  <div id="wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          <div  class="breadcrumb-item" style="padding-left: 25px">
            <button onclick="AttendanceOnly()" id="attendanceOnly">Attendace Only</button><button onclick="RatingOnly()" id="ratingOnly">Ratings</button><button onclick="AllVariable()" id="allVariable">All</button>
          </div>
        </ol>
    ...
    <tbody>
      ...
      $count=0;
        foreach($Students as $RegNo)
        {
          ...
          <tr onkeyup="saverating('<?php echo $RegNo; ?>',
            '<?php echo $Session; ?>',
            '<?php echo $Term; ?>',
            document.getElementById('<?php echo $RegNo."attendance"; ?>').innerHTML,
            document.getElementById('innerHTML<?php echo $RegNo."attentiveness"; ?>').innerHTML,
            document.getElementById('<?php echo $RegNo."neatness"; ?>').innerHTML,
            document.getElementById('<?php echo $RegNo."politeness"; ?>').innerHTML,
            document.getElementById('<?php echo $RegNo."relationship"; ?>').innerHTML,
            document.getElementById('<?php echo $RegNo."curiosity"; ?>').innerHTML,
            document.getElementById('<?php echo $RegNo."honesty"; ?>').innerHTML,
            document.getElementById('<?php echo $RegNo."help_others"; ?>').innerHTML,
            document.getElementById('<?php echo $RegNo."punctuality"; ?>').innerHTML,
            document.getElementById('<?php echo $RegNo."leadership"; ?>').innerHTML,
            document.getElementById('<?php echo $RegNo."emotional_stability"; ?>').innerHTML,
            document.getElementById('<?php echo $RegNo."attitude_to_work"; ?>').innerHTML)">
          <td>$RegNo</td><td>$Student</td>
          
          <td contenteditable="true" id="<?php echo $RegNo; ?>attendance"><?php echo $attendance;?></td>

          <td contenteditable="true" id="<?php echo $RegNo; ?>attentiveness"><?php echo $attentiveness; ?></td>

          <td contenteditable="true" id="<?php echo $RegNo; ?>neatness"><?php echo $neatness;  ?></td>             

          <td contenteditable="true" id="<?php echo $RegNo; ?>politeness" ><?php echo $politeness;  ?></td>
          
          <td contenteditable="true" id="<?php echo $RegNo; ?>relationship" ><?php echo $relationship; ?></td>
          
          <td contenteditable="true" id="<?php echo $RegNo; ?>curiosity"><?php echo $curiosity;  ?></td>
          
          <td contenteditable="true" id="<?php echo $RegNo; ?>honesty" ><?php echo $honesty; ?></td>

          <td contenteditable="true" id="<?php echo $RegNo; ?>help_others" ><?php echo $help_others; ?></td>

          <td contenteditable="true" id="<?php echo $RegNo; ?>punctuality"><?php echo $punctuality; ?></td>

          <td contenteditable="true" id="<?php echo $RegNo; ?>leadership"><?php echo $leadership; ?></td>

          <td contenteditable="true" id="<?php echo $RegNo; ?>emotional_stability" ><?php echo $emotional_stability; ?></td>

          <td contenteditable="true" id="<?php echo $RegNo; ?>attitude_to_work"><?php echo $attitude_to_work; ?></td>
          <?php
        }
      ?>
    </tbody>
