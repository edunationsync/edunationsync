      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <div style="padding-left: 25px">
            <a href="../dashboard/">Dashboard</a> <a href="../dashboard/users/allstudents.php?txtclassp=<?php echo $Class; ?>"  title="Show All Students">Students</a> <a href="../result/psychomotorp.php?classp=<?php echo $Class; ?>&sessionp=<?php echo $Session; ?>&termp=<?php echo $Term; ?>"  title="Open Psychomotor Rating Form">Ratings</a> <a href="../positions.php?sessionp=<?php echo $Session; ?>&termp=<?php echo $Term; ?>&classp=<?php echo $Class; ?>">Positions</a> <a href="index.php" title="Master Sheet Gallery">MSG</a> <a href="../portal/allresultsp.php?prclass=<?php echo $Class; ?>&prsession=<?php echo $Session; ?>&prterm=<?php echo $Term; ?>"  target="_blank" title="Print All Result Sheets">Result Sheets</a> <a href="ca_sheet/ca_sheetall.php?txtsessionp=<?php echo $Session; ?>&txtclassp=<?php echo $Class; ?>&txttermp=<?php echo $Term; ?>" target="_blank" title="Print All CA Sheets">All CA Sheets</a> <a href="ca_sheet/ca_post_sheetall.php?txtsessionp=<?php echo $Session; ?>&txtclassp=<?php echo $Class; ?>&txttermp=<?php echo $Term; ?>"  target="_blank"  title="Print All Pre-filled Sheets"> All Post CA Sheets</a> <a href="ca_sheet/ca_score_sheetall.php?txtsessionp=<?php echo $Session; ?>&txtclassp=<?php echo $Class; ?>&txttermp=<?php echo $Term; ?>" title="Print All CA Score Sheet for this class"  target="_blank" title="Print All Empty Sheets">All Score Sheets</a>        
          
          </div>
          <div style="padding-right: 15px"> | <a href="master_sheet/master_sheet_ca1.php?txtsession=<?php echo $Session; ?>&txtterm=<?php echo $Term; ?>&txtclass=<?php echo $Class; ?>">CA1 Sheet </a> | <a href="master_sheet/master_sheet_ca2.php?txtsession=<?php echo $Session; ?>&txtterm=<?php echo $Term; ?>&txtclass=<?php echo $Class; ?>">CA2 Sheet</a> | <a href="master_sheet/master_sheet_exam.php?txtsession=<?php echo $Session; ?>&txtterm=<?php echo $Term; ?>&txtclass=<?php echo $Class; ?>">Exam Sheet</a> | <a href="result_summary.php?sessionp=<?php echo $Session; ?>&termp=<?php echo $Term; ?>&classp=<?php echo $Class; ?>">Summary Sheet</a> 
        ...
        <ol class="breadcrumb">
          <div style="padding-left: 25px; background: black; padding: 10px 10px 10px 10px; font-size: 12px;">
            ...
            foreach($Classesss as $classes_s)
            {
              ...
              {
                ?>
                <a href="?txtsession=<?php echo $Session; ?>&txtterm=<?php echo $Term ?>&txtclass=<?php echo $classes_s; ?>" style="padding: 4px 4px 4px 4px; margin: 4px 4px 4px 4px; background: white; color: black"><?php echo $classes_s; ?></a>
                <?php
              }
              else
              {
                ?>
                <a href="?txtsession=<?php echo $Session; ?>&txtterm=<?php echo $Term ?>&txtclass=<?php echo $classes_s; ?>" style="padding: 4px 4px 4px 4px; margin: 4px 4px 4px 4px; background: black; color: white;"><?php echo $classes_s; ?></a>
                <?php                
              }
            }
            ?>            
        ...
        <ol class="breadcrumb">
          <div style="padding-left: 25px; background: black; padding: 10px 10px 10px 10px; font-size: 12px;">
            ...
            foreach($Terms as $Term_s)
            {
              ...
              {
                ?>
                <a href="?txtsession=<?php echo $Session; ?>&txtterm=<?php echo $Term_s ?>&txtclass=<?php echo $Class; ?>" style="padding: 4px 4px 4px 4px; margin: 4px 4px 4px 4px; background: white; color: black"><?php echo $Term_s; ?></a>
                <?php
              }
              else
              {
                ?>
                <a href="?txtsession=<?php echo $Session; ?>&txtterm=<?php echo $Term_s ?>&txtclass=<?php echo $Class; ?>" style="padding: 4px 4px 4px 4px; margin: 4px 4px 4px 4px; background: black; color: white;"><?php echo $Term_s; ?></a>
                <?php                
              }
            }
            ?>            
        ...
        <ol class="breadcrumb">
          <div style="padding-left: 25px; background: black; padding: 10px 10px 10px 10px; font-size: 12px;">
            ...
            foreach($Sessions as $Session_s)
            {
              ...
              {
                ?>
                <a href="?txtsession=<?php echo $Session_s; ?>&txtterm=<?php echo $Term ?>&txtclass=<?php echo $Class; ?>" style="padding: 4px 4px 4px 4px; margin: 4px 4px 4px 4px; background: white; color: black"><?php echo $Session_s; ?></a>
                <?php
              }
              else
              {
                ?>
                <a href="?txtsession=<?php echo $Session_s; ?>&txtterm=<?php echo $Term ?>&txtclass=<?php echo $Class; ?>" style="padding: 4px 4px 4px 4px; margin: 4px 4px 4px 4px; background: black; color: white;"><?php echo $Session_s; ?></a>
                <?php                
              }
            }
            ?>
        ...
        <ol class="breadcrumb">
          <div style="padding-right: 15px">
            ...
            {
              ?>
              <button  name="btnSort" id="btnSort" onclick="ProcessPositions('','<?php echo $Session; ?>','<?php echo $Term; ?>','<?php echo $Class; ?>')">POSITIONS</button>
              <?php
            }

            ?>
            <button <?php if ($_GET['btnTotalUpdater']=="true"): ?>style="background: blue; color: white"
              
            <?php endif ?>><a href="./term_sub_result_summary.php?txtsession=<?php echo $Session; ?>&txtterm=<?php echo $Term ?>&txtclass=<?php echo $Class; ?>&btnTotalUpdater=true">Update Analysis Score</a></button><button <?php if ($_GET['btnTotalUpdater']!=="true"): ?>style="background: blue; color: white"
              
            <?php endif ?>><a href="./term_sub_result_summary.php?txtsession=<?php echo $Session; ?>&txtterm=<?php echo $Term ?>&txtclass=<?php echo $Class; ?>" >Load Normal</a></button>
          </div>
          <div style="padding-right: 15px">
            ...
            {
              ?>
                <button onclick="CA1Only()" id="btnca1">CA1</button><button onclick="CA2Only()" id="btnca2">CA2</button><button onclick="BothCA()" id="btnca1ca2">Both CA</button><button onclick="ExamOnly()" id="btnexam">Exam</button><button onclick="AllScores()" id="btnallscores">All</button>
              <?php
            }
            ?>
            <a href="term_sub_result_summary_print.php?txtsession=<?php echo $Session; ?>&txtterm=<?php echo $Term; ?>&txtclass=<?php echo $Class; ?>"><button>Print Preview</button></a>
          </div>  
          <div style="padding-right: 15px">            
            ...
            <td style="border:none">
              ...
              <table cellspacing="0" width="100%" style="font-size: 12px">
                <thead><tr><td width="20px"  valign='top' rowspan='2'><center>REG</center></td><td width="250px" valign='top' rowspan='2'>NAME</td>
                  ...
                  <td  width="70px" valign="top" rowspan='2'><center>CA1 TOTAL</center></td><td  width="70px" valign="top" rowspan='2'><center>CA1 AVER</center></td><td  width="70px" valign="top" rowspan='2'><center>CA1 POS</center></td>

                  <td  width="70px" valign="top" rowspan='2'><center>CA2 TOTAL</center></td><td  width="70px" valign="top" rowspan='2'><center>CA2 AVER</center></td><td  width="70px" valign="top" rowspan='2'><center>CA2 POS</center></td>


                  <td  width="70px" valign="top" rowspan='2'><center>EXAM TOTAL</center></td><td  width="70px" valign="top" rowspan='2'><center>EXAM AVER</center></td><td  width="70px" valign="top" rowspan='2'><center>EXAM POS</center></td>
