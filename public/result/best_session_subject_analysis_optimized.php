    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid"> 
        ...
        <div class="content" id="content" style="padding:20px 20px 20px 20px">
          <header>
            <b>
            <div class="bheader"><center ><img src="../images/school/logo.png" width="100px"/><br/><b ><hd>OVERALL SUBJECT BEST SUMMARY</hd></b><br/>
                  ...
                  <table cellspacing="0" width="100%">
                    ...
                    <thead>
                      <tr>
                        ...
                        <td width="5px" valign="top">TOTAL</td><td width="5px" valign="top">AVERAGE</td><td width="5px" valign="top">POSITION</td>
                      </tr>
                    </thead>
                    <tbody>
                      <?php
