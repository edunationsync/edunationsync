...
<head> 
  ...
  <title>Exam Master Sheet <?php echo $Class.' '.$Session.' '.$Term; ?></title>
  <link rel="icon" type="image/png" href="../../images/school/favicon.png"/>
    ...
    <script type="text/javascript">
        ...
        function computeresult(id,subj)
        {
          ...
          for (var s = subjects.length - 1; s >= 0; s--) {
            ...
            var tt=eval(document.getElementById(ids+subjects[s]+"exam").innerHTML);
            if(tt==null)
            {
              tt=0;
            }
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          <div style="padding-left: 25px; background: black; padding: 10px 10px 10px 10px; font-size: 12px;">
            ...
            foreach($Terms as $Term_s)
            {
              ...
              {
                ?>
                <a href="./master_sheet_exam.php?txtsession=<?php echo $Session; ?>&txtterm=<?php echo $Term_s ?>&txtclass=<?php echo $Class; ?>" style="padding: 4px 4px 4px 4px; margin: 4px 4px 4px 4px; background: white; color: black"><?php echo $Term_s; ?></a>
                <?php
              }
              else
              {
                ?>
                <a href="./master_sheet_exam.php?txtsession=<?php echo $Session; ?>&txtterm=<?php echo $Term_s ?>&txtclass=<?php echo $Class; ?>" style="padding: 4px 4px 4px 4px; margin: 4px 4px 4px 4px; background: black; color: white;"><?php echo $Term_s; ?></a>
                <?php                
              }
            }
            ?>            
        ...
        <ol class="breadcrumb">
          <div style="padding-left: 25px; background: black; padding: 10px 10px 10px 10px; font-size: 12px;">
            ...
            foreach($Sessions as $Session_s)
            {
              ...
              {
                ?>
                <a href="./master_sheet_exam.php?txtsession=<?php echo $Session_s; ?>&txtterm=<?php echo $Term ?>&txtclass=<?php echo $Class; ?>" style="padding: 4px 4px 4px 4px; margin: 4px 4px 4px 4px; background: white; color: black"><?php echo $Session_s; ?></a>
                <?php
              }
              else
              {
                ?>
                <a href="./master_sheet_exam.php?txtsession=<?php echo $Session_s; ?>&txtterm=<?php echo $Term ?>&txtclass=<?php echo $Class; ?>" style="padding: 4px 4px 4px 4px; margin: 4px 4px 4px 4px; background: black; color: white;"><?php echo $Session_s; ?></a>
                <?php                
              }
            }
            ?>
        ...
        <ol class="breadcrumb">
          <div style="padding-right: 15px">
            <a href="master_sheet_exam_print.php?txtsession=<?php echo $Session; ?>&txtterm=<?php echo $Term; ?>&txtclass=<?php echo $Class; ?>" title="Print this Sheet now" target="_blank">Print Preview</a> 
            <?php 

            if($Session==$current['session'] && $Term==$current['term'])
            {
              ?>
              <button onclick="ProcessPositions('Exam','<?php echo $Session; ?>','<?php echo $Term; ?>','<?php echo $Class; ?>')">POSITIONS</button>
              <button onclick="ClearClassPositions('Exam','<?php echo $Session; ?>','<?php echo $Term; ?>','<?php echo $Class; ?>')">CLEAR</button>
              <?php
            }
            ?>
          </div>
          ...
          <div style="padding-right: 15px"><a href="master_sheet_ca1.php?txtsession=<?php echo $Session; ?>&txtterm=<?php echo $Term; ?>&txtclass=<?php echo $Class; ?>">CA1 Sheet </a> | <a href="master_sheet_ca2.php?txtsession=<?php echo $Session; ?>&txtterm=<?php echo $Term; ?>&txtclass=<?php echo $Class; ?>">CA2 Sheet</a> | <a href="master_sheetp.php?txtsession=<?php echo $Session; ?>&txtterm=<?php echo $Term; ?>&txtclass=<?php echo $Class; ?>">Master Sheet</a> | <a href="../result_summary.php?sessionp=<?php echo $Session; ?>&termp=<?php echo $Term; ?>&classp=<?php echo $Class; ?>">Summary Sheet</a> | <a href="report.php?txtsession=<?php echo $Session; ?>&txtterm=<?php echo $Term; ?>&txtclass=<?php echo $Class; ?>">Print Master Sheet</a> 
          </div>
          <div style="padding-right: 15px">            
            ...
            <td style="border:none">
              <header>
                <center><div class="bheader">
                  ...
                  <hd1><?php echo $Session; ?> <?php echo  strtoupper($Term); ?> TERM EXAM MASTER RESULT SHEET  FOR <?php echo strtoupper($Class);  ?></hd1> </div>
                </center>
              </header>
              <table cellspacing="0" width="100%" style="font-size: 12px">
                ...
                <tbody>
                  ...
                  if(isset($_GET['btnSort']))
                  {
                    Module::UpdateTermSubPositions("Exam",$Session,$Term,$Class);
                  }
                  ...
                  foreach($Students as $RegNo)
                  {
                   ...
                   else
                   {
                    ...
                    {
                      Module::SaveExamAnalysisp($RegNo,$Session,$Term,$Class,$ExamPrincipalRemark,$ExamTotal,$Position);
                    }
                      ...
                      if($subNum[$subCnt]==$subCode)
                      {
                        ...
                        $subjectTotalScore=$subResult['total'];
                          ...
                          <td  style='text-align:center; display: none' 
                              ...
                              onfocus="Current(this.id,'<?php echo $RegNo; ?>','ca1','<?php echo $subCode;?>');ShowStatusBar('<?php echo $RegNo; ?>','<?php echo $studentDetails['names']; ?>','<?php echo $RegNo; ?>','CA1','<?php echo $subCode;?>')"><?php echo $ca1; ?>                          
                            </td>
                            <td style='text-align:center; display: none' 
                              ...
                              onfocus="Current(this.id,'<?php echo $RegNo; ?>','ca2','<?php echo $subCode;?>'); ShowStatusBar('<?php echo $RegNo; ?>','<?php echo $studentDetails['names']; ?>','<?php echo $RegNo; ?>','CA2','<?php echo $subCode;?>')"><?php echo $ca2; ?></td>
                            <td style='text-align:center; display: none' 
                              ...
                              onfocus="Current(this.id,'<?php echo $RegNo; ?>','ca3','<?php echo $subCode;?>'); ShowStatusBar('<?php echo $RegNo; ?>','<?php echo $studentDetails['names']; ?>','<?php echo $RegNo; ?>','CA3','<?php echo $subCode;?>')"><?php echo $ca3; ?></td>
                    ...
                    ?>
                    <td  style='text-align:center' id='<?php echo $RegNo."Total" ?>' title="<?php echo $studentDetails['names']; ?>"><?php echo Module::GetTotalExamScorep($RegNo,$Session,$Term,$Class); ?></td>
                      <?php 


                      if(($courseCount)>0){
                        $avr=round((Module::GetTotalExamScorep($RegNo,$Session,$Term,$Class))/($courseCount),2);
                      }
                    ...
                    <td  style='text-align:center; padding-right: 10px' id='<?php echo $RegNo."Remark" ?>'  title="<?php echo $studentDetails['names']; ?>"><!--P Rmk --><?php
                      ...
                      foreach($subjectCriterias as $subjectCriteria)
                      {
                        ...
                        if($subjectResult['exam']<$criteriaScore)
                        {
