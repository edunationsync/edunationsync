...
<head> 
  ...
  <title>Master Sheet <?php echo $Class.' '.$Session.' '.$Term; ?></title>
  <link rel="icon" type="image/png" href="../../images/school/favicon.png"/>
    ...
    <script type="text/javascript">
        ...
        function computeresult(id,subj)
        {
          ...
          for (var s = subjects.length - 1; s >= 0; s--) {
            ...
            var tt=eval(document.getElementById(ids+subjects[s]+"ca3").innerHTML);
            if(tt==null)
            {
              tt=0;
            }
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          <div style="padding-left: 25px; background: black; padding: 10px 10px 10px 10px; font-size: 12px;">
            ...
            foreach($Classesss as $classes_s)
            {
              ...
              {
                ?>
                <a href="./master_sheet_ca2.php?txtsession=<?php echo $Session; ?>&txtterm=<?php echo $Term ?>&txtclass=<?php echo $classes_s; ?>" style="padding: 4px 4px 4px 4px; margin: 4px 4px 4px 4px; background: white; color: black"><?php echo $classes_s; ?></a>
                <?php
              }
              else
              {
                ?>
                <a href="./master_sheet_ca2.php?txtsession=<?php echo $Session; ?>&txtterm=<?php echo $Term ?>&txtclass=<?php echo $classes_s; ?>" style="padding: 4px 4px 4px 4px; margin: 4px 4px 4px 4px; background: black; color: white;"><?php echo $classes_s; ?></a>
                <?php                
              }
            }
            ?>            
        ...
        <ol class="breadcrumb">
          <div style="padding-right: 15px">
            <a href="master_sheet_ca3_print.php?txtsession=<?php echo $Session; ?>&txtterm=<?php echo $Term; ?>&txtclass=<?php echo $Class; ?>" title="Print this Sheet now" target="_blank">Print Preview</a> 
            <?php 
            if($Session==$current['session'] && $Term==$current['term'])
            {
              ?>
            ...
            <td style="border:none">
              <header>
                <center><div class="bheader">
                  ...
                  <hd1><?php echo $Session; ?> <?php echo  strtoupper($Term); ?> TERM CA 3 MASTER RESULT SHEET  FOR <?php echo strtoupper($Class);  ?></hd1> </div>
                </center>
              </header>
              <table cellspacing="0" width="100%" style="font-size: 12px">
                ...
                <tbody>
                  ...
                  if(isset($_GET['btnSort']))
                  {
                    Module::UpdateTermSubPositions("CA3",$Session,$Term,$Class);
                  }
                  ...
                  foreach($Students as $RegNo)
                  {
                   ...
                   else
                   {
                    ...
                    {
                      echo Module::SaveCA3Analysisp($RegNo,$Session,$Term,$Class,$CA3PrincipalRemark,$CA3Total,$Position);
                    }
                    ...
                    ?>
                    <td  style='text-align:center' id='<?php echo $RegNo."Total" ?>' title="<?php echo $studentDetails['names']; ?>"><?php echo Module::GetTotalCa3Scorep($RegNo,$Session,$Term,$Class); ?></td>
                      <?php 


                      if(($courseCount)>0){
                        $avr=round((Module::GetTotalCa3Scorep($RegNo,$Session,$Term,$Class))/($courseCount),2);
                      }
                    ...
                    <td  style='text-align:center; padding-right: 10px' id='<?php echo $RegNo."Remark" ?>'  title="<?php echo $studentDetails['names']; ?>"><!--P Rmk --><?php
                      ...
                      foreach($subjectCriterias as $subjectCriteria)
                      {
                        ...
                        if($subjectResult['ca3']<$criteriaScore)
                        {
