...
<head> 
  ...
  <title>Term Master Sheet <?php echo $Class.' '.$Session.' '.$Term; ?></title>
  <link rel="icon" type="image/png" href="../../images/school/favicon.png"/>
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          <div style="padding-left: 25px; background: black; padding: 10px 10px 10px 10px; font-size: 12px;">
            ...
            foreach($Terms as $Term_s)
            {
              ...
              {
                ?>
                <a href="./master_sheet_total.php?txtsession=<?php echo $Session; ?>&txtterm=<?php echo $Term_s ?>&txtclass=<?php echo $Class; ?>" style="padding: 4px 4px 4px 4px; margin: 4px 4px 4px 4px; background: white; color: black"><?php echo $Term_s; ?></a>
                <?php
              }
              else
              {
                ?>
                <a href="./master_sheet_total.php?txtsession=<?php echo $Session; ?>&txtterm=<?php echo $Term_s ?>&txtclass=<?php echo $Class; ?>" style="padding: 4px 4px 4px 4px; margin: 4px 4px 4px 4px; background: black; color: white;"><?php echo $Term_s; ?></a>
                <?php                
              }
            }
            ?>            
        ...
        <ol class="breadcrumb">
          <div style="padding-left: 25px; background: black; padding: 10px 10px 10px 10px; font-size: 12px;">
            ...
            foreach($Sessions as $Session_s)
            {
              ...
              {
                ?>
                <a href="./master_sheet_total.php?txtsession=<?php echo $Session_s; ?>&txtterm=<?php echo $Term ?>&txtclass=<?php echo $Class; ?>" style="padding: 4px 4px 4px 4px; margin: 4px 4px 4px 4px; background: white; color: black"><?php echo $Session_s; ?></a>
                <?php
              }
              else
              {
                ?>
                <a href="./master_sheet_total.php?txtsession=<?php echo $Session_s; ?>&txtterm=<?php echo $Term ?>&txtclass=<?php echo $Class; ?>" style="padding: 4px 4px 4px 4px; margin: 4px 4px 4px 4px; background: black; color: white;"><?php echo $Session_s; ?></a>
                <?php                
              }
            }
            ?>
        ...
        <ol class="breadcrumb">
          <div style="padding-right: 15px">
            <a href="master_sheet_total_print.php?txtsession=<?php echo $Session; ?>&txtterm=<?php echo $Term; ?>&txtclass=<?php echo $Class; ?>" title="Print this Sheet now" target="_blank">Print Preview</a> | <a href="master_sheet_total_analysis_print.php?txtsession=<?php echo $Session; ?>&txtterm=<?php echo $Term; ?>&txtclass=<?php echo $Class; ?>" title="Print this Sheet now" target="_blank">Print for Analysis</a> 
            <?php 
            ...
            <td style="border:none">
              <header>
                <center><div class="bheader">
                  ...
                  <hd1><?php echo $Session; ?> <?php echo  strtoupper($Term); ?> TERM RESULT SHEET  FOR <?php echo strtoupper($Class);  ?></hd1> </div>
                </center>
              </header>
              <table cellspacing="0" width="100%" style="font-size: 12px">
                <thead><tr><td width="20px"  valign='top'><center>REG</center></td><td width="250px" valign='top'>NAME</td>
                  <?php
                  $cnt=0;
                  ...
                  <td  width="70px" valign="top"><center>TOTAL</center></td><td  width="70px" valign="top"><center>AVER</center></td><td  width="70px" valign="top"><center>POSITION</center></td><td  width="70px" valign="top"><center>COMMENT</center></td></tr>
                ...
                <tbody>
                  ...
                  foreach($Students as $RegNo)
                  {
                    ...
                    foreach($Subjects as $subCode)
                    {
                      ...
                      if($subNum[$subCnt]==$subCode)
                      {
                        ...
                        $subjectTotalScore=$subResult['total'];
                          ...
                          ?>
                            <td style='text-align:center; font-weight: bolder;'  id="<?php echo $RegNo.$subCode.'subjectTotalScore'; ?>" title="<?php echo $RegNo.$studentDetails['names'].$subCode.'subjectTotalScore'; ?>" ><?php echo round($subjectTotalScore,2); ?></td>
                    ...
                    ?>
                    <td  style='text-align:center' id='<?php echo $RegNo."Total" ?>' title="<?php echo $studentDetails['names']; ?>"><?php echo round($Total,2); ?></td>
                    ...
                    <td  style='text-align:center; padding-right: 10px' id='<?php echo $RegNo."Remark" ?>'  title="<?php echo $studentDetails['names']; ?>"><!--P Rmk --><?php
                      ...
                      foreach($subjectCriterias as $subjectCriteria)
                      {
                        ...
                        if($subjectResult['total']<$criteriaScore)
                        {
