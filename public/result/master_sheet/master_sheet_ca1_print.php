            ...
            <td style="border:none">
              ...
              <table cellspacing="0" width="100%" style="font-size: 12px">
                <thead><tr><td width="20px"  valign='top'><center>REG</center></td><td width="250px" valign='top'>NAME</td>
                  ...
                  <td  width="70px" valign="top"><center>TOTAL</center></td><td  width="70px" valign="top"><center>AVER</center></td><td  width="70px" valign="top"><center>GRADE</center></td><td  width="70px" valign="top" ><center>REMARK</center></td><!--<td  width="70px" valign="top"><center>FORM M. REMARK</center></td><td  width="70px" valign="top"><center>ATTENDANCE</center></td><td  width="70px" valign="top"><center>CONDUCT</center></td><td  width="70px" valign="top"><center>APPEARANCE</center></td>--></tr>
                    ...
                    foreach($Subjects as $subCode)
                    {
                      ...
                      if($subNum[$subCnt]==$subCode)
                      {
                        ...
                        $subjectTotalScore=$subResult['total'];
                          ...
                          ?>
                          <td  style='text-align:center'><?php echo $ca1; ?>                          
                            </td>
                          </td>
                          <?php
