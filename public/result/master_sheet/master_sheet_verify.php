            ...
            <td style="border:none">
              ...
              <table cellspacing="0" width="100%" style="font-size: 12px">
                <thead><tr><td width="20px"  valign='top' rowspan='2'><center>REG</center></td><td width="250px" valign='top' rowspan='2'>NAME</td>
                  ...
                  <td  width="70px" valign="top" rowspan='2'><center>TOTAL</center></td><td  width="70px" valign="top" rowspan='2'><center>AVER</center></td></tr>
                  <?php
                  echo "<tr>";
                    foreach($Subjects as $subject)
                    { 
                      echo "<td valign='top'><center>CA1</center></td><td valign='top'><center>CA2</center></td><td valign='top'><center>CA3</center></td><td valign='top'><center>EXAM</center></td>";
                    }
