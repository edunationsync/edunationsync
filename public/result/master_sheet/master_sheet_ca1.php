...
<head> 
  ...
  <title>CA1 Master Sheet <?php echo $Class.' '.$Session.' '.$Term; ?></title>
  <link rel="icon" type="image/png" href="../../images/school/favicon.png"/>
    ...
    <script type="text/javascript">
        ...
        function computeresult(id,subj)
        {
          ...
          for (var s = subjects.length - 1; s >= 0; s--) {
            ...
            var tt=eval(document.getElementById(ids+subjects[s]+"ca1").innerHTML);
            if(tt==null)
            {
              tt=0;
            }
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          <div style="padding-left: 25px; background: black; padding: 10px 10px 10px 10px; font-size: 12px;">
            ...
            foreach($Terms as $Term_s)
            {
              ...
              {
                ?>
                <a href="./master_sheet_ca1.php?txtsession=<?php echo $Session; ?>&txtterm=<?php echo $Term_s ?>&txtclass=<?php echo $Class; ?>" style="padding: 4px 4px 4px 4px; margin: 4px 4px 4px 4px; background: white; color: black"><?php echo $Term_s; ?></a>
                <?php
              }
              else
              {
                ?>
                <a href="./master_sheet_ca1.php?txtsession=<?php echo $Session; ?>&txtterm=<?php echo $Term_s ?>&txtclass=<?php echo $Class; ?>" style="padding: 4px 4px 4px 4px; margin: 4px 4px 4px 4px; background: black; color: white;"><?php echo $Term_s; ?></a>
                <?php                
              }
            }
            ?>            
        ...
        <ol class="breadcrumb">
          <div style="padding-left: 25px; background: black; padding: 10px 10px 10px 10px; font-size: 12px;">
            ...
            foreach($Sessions as $Session_s)
            {
              ...
              {
                ?>
                <a href="./master_sheet_ca1.php?txtsession=<?php echo $Session_s; ?>&txtterm=<?php echo $Term ?>&txtclass=<?php echo $Class; ?>" style="padding: 4px 4px 4px 4px; margin: 4px 4px 4px 4px; background: white; color: black"><?php echo $Session_s; ?></a>
                <?php
              }
              else
              {
                ?>
                <a href="./master_sheet_ca1.php?txtsession=<?php echo $Session_s; ?>&txtterm=<?php echo $Term ?>&txtclass=<?php echo $Class; ?>" style="padding: 4px 4px 4px 4px; margin: 4px 4px 4px 4px; background: black; color: white;"><?php echo $Session_s; ?></a>
                <?php                
              }
            }
            ?>
        ...
        <ol class="breadcrumb">
          <div style="padding-right: 15px">
             <a href="master_sheet_ca1_print.php?txtsession=<?php echo $Session; ?>&txtterm=<?php echo $Term; ?>&txtclass=<?php echo $Class; ?>" title="Print this Sheet now" target="_blank">Print Preview</a> 
            <?php 

            if($Session==$current['session'] && $Term==$current['term'])
            {
              ?>
              <button  name="btnSort" id="btnSort" onclick="ProcessPositions('CA1','<?php echo $Session; ?>','<?php echo $Term; ?>','<?php echo $Class; ?>')">POSITIONS</button> 
              <button  name="btnSort" id="btnSort" onclick="ClearClassPositions('CA1','<?php echo $Session; ?>','<?php echo $Term; ?>','<?php echo $Class; ?>')">CLEAR</button>
              <?php
            }
            ...
            <td style="border:none">
              <header>
                <center><div class="bheader">
                  ...
                  <hd1><?php echo $Session; ?> <?php echo  strtoupper($Term); ?> TERM CA 1 MASTER RESULT SHEET  FOR <?php echo strtoupper($Class);  ?></hd1> </div>
                </center>
              </header>
              <table cellspacing="0" width="100%" style="font-size: 12px">
                <thead><tr><td width="20px"  valign='top' rowspan='2'><center>REG</center></td><td width="250px" valign='top' rowspan='2'>NAME</td>
                  ...
                  <td  width="70px" valign="top" rowspan='2'><center>TOTAL</center></td><td  width="70px" valign="top" rowspan='2'><center>AVER</center></td><td  width="70px" valign="top" rowspan='2'><center>GRADE</center></td><td  width="70px" valign="top" rowspan='2'><center>REMARK</center></td><td  width="70px" valign="top" rowspan='2'><center>PRINCIPAL REMARK</center></td><!--<td  width="70px" valign="top"><center>FORM M. REMARK</center></td><td  width="70px" valign="top"><center>ATTENDANCE</center></td><td  width="70px" valign="top"><center>CONDUCT</center></td><td  width="70px" valign="top"><center>APPEARANCE</center></td>--></tr>
                ...
                <tbody>
                  ...
                  if(isset($_GET['btnSort']))
                  {
                    Module::UpdateTermSubPositions("CA1",$Session,$Term,$Class);
                  }
                  ...
                  foreach($Students as $RegNo)
                  {
                   ...
                   else
                   {
                    ...
                    {
                      Module::SaveCA1Analysisp($RegNo,$Session,$Term,$Class,$CA1PrincipalRemark,$CA1Total,$Position);
                    }
                    ...
                    ?>
                    <td  style='text-align:center' id='<?php echo $RegNo."Total" ?>' title="<?php echo $studentDetails['names']; ?>"><?php echo Module::GetTotalCa1Scorep($RegNo,$Session,$Term,$Class); ?></td>
                      <?php 


                      if(($courseCount)>0){
                        $avr=round((Module::GetTotalCa1Scorep($RegNo,$Session,$Term,$Class))/($courseCount),2);
                      }
                    ...
                    <td  style='text-align:center; padding-right: 10px' id='<?php echo $RegNo."Remark" ?>'  title="<?php echo $studentDetails['names']; ?>"><!--P Rmk --><?php
                      ...
                      foreach($subjectCriterias as $subjectCriteria)
                      {
                        ...
                        if($subjectResult['ca1']<$criteriaScore)
                        {
                    ...
                    <td  style='text-align:center; padding-right: 10px' id='<?php echo $RegNo."Remark" ?>'  title="<?php echo $studentDetails['names']; ?>"><!--P Rmk -->
                      <?php echo $CA1PrincipalRemark; ?></td>
                    <?php
                  }
                  ?>
                </tbody>
