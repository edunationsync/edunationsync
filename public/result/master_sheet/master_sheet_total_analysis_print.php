...
<head> 
  ...
  <title>PROMOTION ANALYSIS SHEETSFOR <?php echo $Class.' '.$Session; ?></title>
  <link rel="icon" type="image/png" href="../../images/school/favicon.png"/>
            ...
            <td style="border:none">
              ...
              <table cellspacing="0" width="100%" style="font-size: 12px">
                <thead><tr><td width="20px"  valign='top'><center>REG</center></td><td width="250px" valign='top'>NAME</td>
                  ...
                  <td  width="70px" valign="top"><center>TOTAL</center></td><td  width="70px" valign="top"><center>AVER</center></td><td  width="70px" valign="top"><center>POSITION</center></td>></tr>
                  ...
                  foreach($Students as $RegNo)
                  {
                    ...
                    foreach($Subjects as $subCode)
                    {
                      ...
                      if($subNum[$subCnt]==$subCode)
                      {
                        ...
                        ?>
                        <td><center><?php echo $subOverallResult['average']; ?></center></td>
                        <?php                        
                      }
                      else
                      {
