              ...
              <td style="border:none">
                <header>
                  ...
                  <table cellspacing="0" width="100%">
                    ...
                    <thead>
                    <tr><td  width="40px"  valign="top">REG. NO.</td><td  valign="top" style="width: 300px">NAME</td><td width="5px" valign="top">CA1 TOT</td><td width="5px" valign="top">CA1 AVER</td><td width="5px" valign="top">CA1 REM</td><td width="5px" valign="top">CA1 POS</td><td width="5px" valign="top">CA2 TOT</td><td width="5px" valign="top">CA2 AVER</td><td width="5px" valign="top">CA2 REM</td><td width="5px" valign="top">CA2 POS</td><td width="5px" valign="top">EXAM TOT</td><td width="5px" valign="top">EXAM AVER</td><td width="5px" valign="top">EXAM REM</td><td width="5px" valign="top">EXAM POS</td><td width="5px" valign="top">TOTAL</td><td width="5px" valign="top">AVERAGE</td><td width="5px" valign="top">POSITION</td><td  width="70px" valign="top">GRADE</td><td  width="70px" valign="top">REMARK</td></tr></thead>
                    <tbody>
                      <?php
                      $count=0;
