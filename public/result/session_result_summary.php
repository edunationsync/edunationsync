...
<body id="page-top">
  ...
  <div id="wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          <li class="breadcrumb-item">
            <a href="session_result_summary_print.php?sessionp=<?php echo $Session; ?>&termp=<?php echo $Term ?>&classp=<?php echo $Class; ?>" style="padding: 4px 4px 4px 4px; margin: 4px 4px 4px 4px; background: white; color: black">Print Session Summary</a> | <button <?php if ($_GET['btnTotalUpdater']!=="true"): ?>style="background: blue; color: white; padding: 4px 4px 4px 4px; margin: 4px 4px 4px 4px; "
              
            <?php else: ?>style="background: white; color: black; padding: 4px 4px 4px 4px; margin: 4px 4px 4px 4px; "
              
            <?php endif ?>><a href="session_result_summary.php?sessionp=<?php echo $Session; ?>&termp=<?php echo $Term ?>&classp=<?php echo $Class; ?>">Normal Summary</a></button> | <button  <?php if ($_GET['btnTotalUpdater']=="true"): ?>style="background: blue; color: white; padding: 4px 4px 4px 4px; margin: 4px 4px 4px 4px; "
              
            <?php else: ?>style="background: white; color: black; padding: 4px 4px 4px 4px; margin: 4px 4px 4px 4px; "
              
            <?php endif ?>><a href="session_result_summary.php?sessionp=<?php echo $Session; ?>&classp=<?php echo $Class; ?>&btnTotalUpdater=true" >Update Session Result</a></button> | <button onclick="UpdateAnalysis('<?php echo $Class;?>','<?php echo $Session;?>','<?php echo $Term; ?>');">Update Analysis</button> | <button  ><a href="best_session_result_summary.php?sessionp=<?php echo $Session_s; ?>&classp=<?php echo $Class; ?>" >Best Session Summary</a></button>
          </li>
          <div style="padding-left: 25px">
            ...
            <table>
              <tr>
                <td style="padding: 10px 10px 10px 10px">
                  <?php
                  if(Module::IsNotSessionPositionUpdated($Session,$Class))
                  {
                    ?>
                    <button onclick="ProcessSessionClassPositions('<?php echo $Session; ?>','<?php echo $Class; ?>')">GENERATE</button>
                    <?php
                  }
                  else
                  {
                    ?>
                    <button onclick="ProcessSessionClassPositions('<?php echo $Session; ?>','<?php echo $Class; ?>')">UPDATE</button> <button onclick="ClearSessionClassPositions('<?php echo $Session; ?>','<?php echo $Class; ?>')">CEAR</button>
                    <?php
                  }
                  ?>
                </td>
            ...
            <tr>
              <td style="border:none">
                  <table cellspacing="0" width="100%">
                    ...
                    <thead>
                    <tr><td  width="40px"  valign="top">REG. NO.</td><td  valign="top" style="width: 300px">NAME</td><td width="5px" valign="top">1<sup>ST</sup> TERM TOT</td><td width="5px" valign="top">1<sup>ST</sup> TERM AVER</td><td width="5px" valign="top">1<sup>ST</sup> TERM POS</td><td width="5px" valign="top">1<sup>ST</sup> TERM GR</td><td width="5px" valign="top">1<sup>ST</sup> TERM REM</td>
                      <td width="5px" valign="top">2<sup>ND</sup> TERM TOT</td><td width="5px" valign="top">2<sup>ND</sup> TERM AVER</td><td width="5px" valign="top">2<sup>ND</sup> TERM POS</td><td width="5px" valign="top">2<sup>ND</sup> TERM GR</td><td width="5px" valign="top">2<sup>ND</sup> TERM REM</td>
                      <td width="5px" valign="top">3<sup>RD</sup> TERM TOT</td><td width="5px" valign="top">3<sup>RD</sup> TERM AVER</td><td width="5px" valign="top">3<sup>RD</sup> TERM POS</td><td width="5px" valign="top">3<sup>RD</sup> TERM GR</td><td width="5px" valign="top">3<sup>RD</sup> TERM REM</td>

                      <td width="5px" valign="top">TOTAL</td><td width="5px" valign="top">AVERAGE</td><td width="5px" valign="top">POSITION</td><td  width="70px" valign="top">GRADE</td><td  width="70px" valign="top">REMARK</td></tr></thead>
                    <tbody>
                      <?php
                      $count=0;
                      ...
                      foreach($Students as $RegNo)
                      {
                        ...
                        if(isset($_GET['btnTotalUpdater']) &&($_GET['btnTotalUpdater']=="true"))
                        {
                          ...
                          Analysis::ProcessSessionResultAnalysisp($RegNo,$Class,$Session);
                        }
                        ...
                        ?>
                          ...
                          <td class="data" id="<?php echo $RegNo; ?>ca1T" <?php if ($resAnalysis['1st_term_position']==1): ?> style="background: green; color: white"
                            
                          <?php elseif($resAnalysis['1st_term_position']==2): ?>
                            style="background: lightgreen; color: black"
                            
                          <?php elseif($resAnalysis['1st_term_position']==3): ?>
                            style="background: lightpink; color: black"
                          <?php endif ?>  ><?php echo $resAnalysis['1st_term_total']; ?></td>
                          <td class="data" id="<?php echo $RegNo; ?>ca1Avr" <?php if ($resAnalysis['1st_term_position']==1): ?> style="background: green; color: white"
                          ...
                          <?php elseif($resAnalysis['1st_term_position']==3): ?>
                            style="background: lightpink; color: black"
                          <?php endif ?>  ><?php echo $resAnalysis['1st_term_average']; ?></td>
                          <td class="data" id="<?php echo $RegNo; ?>ca1Avr" <?php if ($resAnalysis['1st_term_position']==1): ?> style="background: green; color: white"
                          ...
                          <?php elseif($resAnalysis['1st_term_position']==3): ?>
                            style="background: lightpink; color: black"
                          <?php endif ?>  >                            
                            <?php if($resAnalysis['1st_term_position']>0){ echo $resAnalysis['1st_term_position'];

                              $l1Pos=substr($resAnalysis['1st_term_position'], strlen($resAnalysis['1st_term_position'])-1,1);      
                              if($l1Pos==1 && $resAnalysis['1st_term_position']!=11)
                              {
                                echo "<sup>st</sup>";        
                              }
                              elseif($l1Pos==2  && $resAnalysis['1st_term_position']!=12)
                              {
                                echo "<sup>nd</sup>";        
                              }
                              elseif($l1Pos==3  && $resAnalysis['1st_term_position']!=13)
                              {
                                echo "<sup>rd</sup>";        
                              }
                              elseif($l1Pos=='' || $resAnalysis['1st_term_position']=0)
                              {
                                echo "<sup></sup>";        
                              }
                              else
                          ...
                          <td class="data" id="<?php echo $RegNo; ?>ca2T"   <?php if ($resAnalysis['1st_term_position']==1): ?> style="background: green; color: white"
                          ...
                          <?php elseif($resAnalysis['1st_term_position']==3): ?>
                            style="background: lightpink; color: black"
                          <?php endif ?>  ><?php echo $resAnalysis['1st_term_grade']; ?></td>
                          ...
                          <?php elseif($resAnalysis['1st_term_position']==3): ?>
                            style="background: lightpink; color: black"
                          <?php endif ?>  ><?php echo $resAnalysis['1st_term_remark']; ?></td>





                          <td class="data" id="<?php echo $RegNo; ?>ca1T" <?php if ($resAnalysis['2nd_term_position']==1): ?> style="background: green; color: white"
                            
                          <?php elseif($resAnalysis['2nd_term_position']==2): ?>
                            style="background: lightgreen; color: black"
                            
                          <?php elseif($resAnalysis['2nd_term_position']==3): ?>
                            style="background: lightpink; color: black"
                          <?php endif ?>  ><?php echo $resAnalysis['2nd_term_total']; ?></td>
                          <td class="data" id="<?php echo $RegNo; ?>ca1Avr" <?php if ($resAnalysis['2nd_term_position']==1): ?> style="background: green; color: white"
                          ...
                          <?php elseif($resAnalysis['2nd_term_position']==3): ?>
                            style="background: lightpink; color: black"
                          <?php endif ?>  ><?php echo $resAnalysis['2nd_term_average']; ?></td>
                          <td class="data" id="<?php echo $RegNo; ?>ca1Avr" <?php if ($resAnalysis['2nd_term_position']==1): ?> style="background: green; color: white"
                          ...
                          <?php elseif($resAnalysis['2nd_term_position']==3): ?>
                            style="background: lightpink; color: black"
                          <?php endif ?>  >                            
                            <?php if($resAnalysis['2nd_term_position']>0){ echo $resAnalysis['2nd_term_position'];

                              $l2Pos=substr($resAnalysis['2nd_term_position'], strlen($resAnalysis['2nd_term_position'])-1,1);      
                              if($l2Pos==1 && $resAnalysis['2nd_term_position']!=11)
                              {
                                echo "<sup>st</sup>";        
                              }
                              elseif($l2Pos==2  && $resAnalysis['2nd_term_position']!=12)
                              {
                                echo "<sup>nd</sup>";        
                              }
                              elseif($l2Pos==3  && $resAnalysis['2nd_term_position']!=13)
                              {
                                echo "<sup>rd</sup>";        
                              }
                              elseif($l2Pos=='' || $resAnalysis['2nd_term_position']=0)
                              {
                                echo "<sup></sup>";        
                              }
                              else
                          ...
                          <td class="data" id="<?php echo $RegNo; ?>ca2T"   <?php if ($resAnalysis['2nd_term_position']==1): ?> style="background: green; color: white"
                          ...
                          <?php elseif($resAnalysis['2nd_term_position']==3): ?>
                            style="background: lightpink; color: black"
                          <?php endif ?>  ><?php echo $resAnalysis['2nd_term_grade']; ?></td>
                          ...
                          <?php elseif($resAnalysis['2nd_term_position']==3): ?>
                            style="background: lightpink; color: black"
                          <?php endif ?>  ><?php echo $resAnalysis['2nd_term_remark']; ?></td>





                          <td class="data" id="<?php echo $RegNo; ?>ca1T" <?php if ($resAnalysis['3rd_term_position']==1): ?> style="background: green; color: white"
                            
                          <?php elseif($resAnalysis['3rd_term_position']==2): ?>
                            style="background: lightgreen; color: black"
                            
                          <?php elseif($resAnalysis['3rd_term_position']==3): ?>
                            style="background: lightpink; color: black"
                          <?php endif ?>  ><?php echo $resAnalysis['3rd_term_total']; ?></td>
                          <td class="data" id="<?php echo $RegNo; ?>ca1Avr" <?php if ($resAnalysis['3rd_term_position']==1): ?> style="background: green; color: white"
                          ...
                          <?php elseif($resAnalysis['3rd_term_position']==3): ?>
                            style="background: lightpink; color: black"
                          <?php endif ?>  ><?php echo $resAnalysis['3rd_term_average']; ?></td>
                          <td class="data" id="<?php echo $RegNo; ?>ca1Avr" <?php if ($resAnalysis['3rd_term_position']==1): ?> style="background: green; color: white"
                          ...
                          <?php elseif($resAnalysis['3rd_term_position']==3): ?>
                            style="background: lightpink; color: black"
                          <?php endif ?>  >                            
                            <?php if($resAnalysis['3rd_term_position']>0){ 
                              echo $resAnalysis['3rd_term_position'];

                              $lPos=substr($resAnalysis['3rd_term_position'], strlen($resAnalysis['3rd_term_position'])-1,1);      
                              if($lPos==1 && $resAnalysis['3rd_term_position']!=11)
                              {
                                echo "<sup>st</sup>";        
                              }
                              elseif($lPos==2  && $resAnalysis['3rd_term_position']!=12)
                              {
                                echo "<sup>nd</sup>";        
                              }
                              elseif($lPos==3  && $resAnalysis['3rd_term_position']!=13)
                              {
                                echo "<sup>rd</sup>";        
                              }
                              elseif($lPos=='' || $resAnalysis['3rd_term_position']=0)
                              {
                                echo "<sup></sup>";        
                              }
                              else
                          ...
                          <td class="data" id="<?php echo $RegNo; ?>ca2T"   <?php if ($resAnalysis['3rd_term_position']==1): ?> style="background: green; color: white"
                          ...
                          <?php elseif($resAnalysis['3rd_term_position']==3): ?>
                            style="background: lightpink; color: black"
                          <?php endif ?>  ><?php echo $resAnalysis['3rd_term_grade']; ?></td>
                          ...
                          <?php elseif($resAnalysis['3rd_term_position']==3): ?>
                            style="background: lightpink; color: black"
                          <?php endif ?>  ><?php echo $resAnalysis['3rd_term_remark']; ?></td>
                          ...
                          <td class="data" id="<?php echo $RegNo; ?>Total"  <?php if ($resAnalysis['position']==1): ?> style="background: green; color: white"
                            
                          <?php elseif($resAnalysis['position']==2): ?>
                            style="background: lightgreen; color: black"
                            
                          <?php elseif($resAnalysis['position']==3): ?>
                            style="background: lightpink; color: black"
                          <?php endif ?>  ><?php echo $resAnalysis['total']; ?></td>
                          <td class="data" id="<?php echo $RegNo; ?>Average"  <?php if ($resAnalysis['position']==1): ?> style="background: green; color: white"
                          ...
                          <?php elseif($resAnalysis['position']==3): ?>
                            style="background: lightpink; color: black"
                          <?php endif ?>  ><?php echo $resAnalysis['average']; ?></td>
                          <td class="data" id="<?php echo $RegNo; ?>Position"  <?php if ($resAnalysis['position']==1): ?> style="background: green; color: white"
                          ...
                          <?php elseif($resAnalysis['position']==3): ?>
                            style="background: lightpink; color: black"
                          <?php endif ?>  ><?php if($resAnalysis['position']>0){ echo $resAnalysis['position'];
                            ...
                            ?></td>             
                          <td class="data" id="<?php echo $RegNo; ?>Grade"><?php echo $resAnalysis['grade'];  ?></td>
                          <td class="data" id="<?php echo $RegNo; ?>Remark" contenteditable="true" onkeydown="if(event.keyCode==9){UpdateRemarkManually('<?php echo $RegNo;?>','<?php echo $Session;?>','<?php echo $Term;?>','<?php echo $Class;?>',this.innerHTML)}"><?php echo $resAnalysis['remark'];  ?></td>
                        </tr>
