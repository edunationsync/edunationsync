                ...
                <header>
                  ...
                  <table cellspacing="0" width="100%">
                    ...
                    <tr><td  width="40px"  valign="top">S/NO</td>
                      ...
                      <td  valign="top" >TOTAL STUDENTS</td>
                      <td width="5px" valign="top">TOTAL PASS</td>
                      <td width="5px" valign="top">TOTAL FAIL</td>
                      <td width="5px" valign="top">TOTAL ABSENT</td>
                      <td width="5px" valign="top">H S</td>
                      <td width="5px" valign="top">TOTAL HIGH SCORE</td>
                      <td width="5px" valign="top">L S</td>
                      <td width="5px" valign="top">TOTAL LEAST SCORE</td>
                      <?php 
