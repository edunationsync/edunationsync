              ...
              <table cellspacing="0" width="100%">
                ...
                <tbody>
                  ...
                  foreach($Students as $RegNo)
                  {
                    ...
                    ?>
                      <td class="data" contenteditable="<?php echo $editStatus; ?>" id="<?php echo $RegNo.$Subject; ?>ca1"  ></td>
                      <td class="data" contenteditable="<?php echo $editStatus; ?>" id="<?php echo $RegNo.$Subject; ?>ca2"></td>
                      <td class="data" contenteditable="<?php echo $editStatus; ?>" id="<?php echo $RegNo.$Subject; ?>ca3"></td>
                      <td class="data" id="<?php echo $RegNo.$Subject; ?>caT"></td>
                      <td class="data" contenteditable="<?php echo $editStatus; ?>"  id="<?php echo $RegNo.$Subject; ?>exam"></td>
                      <td class="data" id="<?php echo $RegNo.$Subject; ?>exT"></td>
                      <td class="data" id="<?php echo $RegNo.$Subject; ?>Pos"></td>             
                      <td class="data" id="<?php echo $RegNo.$Subject; ?>Gr"></td>
                      <td class="data" id="<?php echo $RegNo.$Subject; ?>Re"></td>
                    </tr>
