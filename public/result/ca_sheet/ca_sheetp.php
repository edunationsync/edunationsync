              ...
              <tbody>
                ...
                foreach($Students as $RegNo)
                {
                  ...
                  <tr id="<?php echo $RegNo;?>" onkeyup="if(event.keyCode==9){
                    ...
                    <td class="data"id="<?php echo $RegNo; ?>ca1" ><?php if($cA1>0){echo $cA1;}else{}  ?></td>
                    <td class="data" id="<?php echo $RegNo; ?>ca2"><?php  if($cA2>0){echo $cA2;}else{}  ?></td>
                    <td class="data" id="<?php echo $RegNo; ?>ca3"><?php  if($cA3>0){echo $cA3;}else{}  ?></td>
                    <td class="data" id="<?php echo $RegNo; ?>caT"><?php echo $caTotal;  ?></td>
                    <td class="data" id="<?php echo $RegNo; ?>exam"><?php if($exam>0){echo $exam;}else{} ?></td>
