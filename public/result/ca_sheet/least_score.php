...
//if(!(isset($Score)))
  ...
  $Students=Analysis::ReadSubjectScoreStudents($Class,$Session,$Term,$Subject,$Score);
...
<head> 
  ...
  <script type="text/javascript">
      ...
      function Current(rowid)
      {
        ...
        document.getElementById(rowid).style.backgroundColor="purple";
      }
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          <div style="padding-left: 25px; background: black; padding: 10px 10px 10px 10px; font-size: 12px;">
            ...
            foreach($Sessions as $Session_s)
            {
              ...
              {
                ?>
                <a href="?txtsessionp=<?php echo $Session_s; ?>&txttermp=<?php echo $Term ?>&txtclassp=<?php echo $Class ?>&txtsubjectp=<?php echo $Subject; ?>" style="padding: 4px 4px 4px 4px; margin: 4px 4px 4px 4px; background: white; color: black"><?php echo $Session_s; ?></a>
                <?php
              }
              else
              {
                ?>
                <a href="?txtsessionp=<?php echo $Session_s; ?>&txttermp=<?php echo $Term ?>&txtclassp=<?php echo $Class ?>&txtsubjectp=<?php echo $Subject; ?>" style="padding: 4px 4px 4px 4px; margin: 4px 4px 4px 4px; background: black; color: white;"><?php echo $Session_s; ?></a>
                <?php                
              }
            }
            ?>
        ...
        <ol class="breadcrumb">
          <div style="padding-left: 25px; background: black; padding: 10px 10px 10px 10px; font-size: 12px;">
            ...
            foreach($Terms as $Term_s)
            {
              ...
              {
                ?>
                <a href="?txtsessionp=<?php echo $Session; ?>&txttermp=<?php echo $Term_s ?>&txtclassp=<?php echo $Class ?>&txtsubjectp=<?php echo $Subject; ?>" style="padding: 4px 4px 4px 4px; margin: 4px 4px 4px 4px; background: white; color: black"><?php echo $Term_s; ?></a>
                <?php
              }
              else
              {
                ?>
                <a href="?txtsessionp=<?php echo $Session; ?>&txttermp=<?php echo $Term_s ?>&txtclassp=<?php echo $Class ?>&txtsubjectp=<?php echo $Subject; ?>" style="padding: 4px 4px 4px 4px; margin: 4px 4px 4px 4px; background: black; color: white;"><?php echo $Term_s; ?></a>
                <?php                
              }
            }
            ?>            
        ...
        <ol class="breadcrumb">
          <div style="padding-left: 25px; background: black; padding: 10px 10px 10px 10px; font-size: 12px;">
            ...
            foreach($Classesss as $classes_s)
            {
              ...
              {
                ?>
                <a href="./index.php?txtsessionp=<?php echo $Session; ?>&txttermp=<?php echo $Term ?>&txtclassp=<?php echo $classes_s; ?>&txtsubjectp=<?php echo $Subject; ?>" style="padding: 4px 4px 4px 4px; margin: 4px 4px 4px 4px; background: white; color: black"><?php echo $classes_s; ?></a>
                <?php
              }
              else
              {
                ?>
                <a href="./index.php?txtsessionp=<?php echo $Session; ?>&txttermp=<?php echo $Term ?>&txtclassp=<?php echo $classes_s; ?>&txtsubjectp=<?php echo $_GET['txtsubjectp']; ?>" style="padding: 4px 4px 4px 4px; margin: 4px 4px 4px 4px; background: black; color: white;"><?php echo $classes_s; ?></a>
                <?php                
              }
            }
            ?>
        ...
        <ol class="breadcrumb">
          ...
          <div style="padding-left: 25px"><button onclick="CA1Only()" id="ca1btn">CA1</button><button onclick="CA12Only()" id="ca12btn">CA1,2</button><button onclick="CA12ExOnly()" id="ca12Exbtn">CA1,2&Ex</button>
            ...
            <button onclick="CA23ExOnly()" id="ca23Exbtn">CA2,3&Ex</button><button onclick="CA3Only()" id="ca3btn">CA3</button><button onclick="CA3ExOnly()" id="ca3Exbtn">CA3,Ex</button><button onclick="BothCA()" id="bothcabtn">All CA</button><button onclick="ExamOnly()" id="exambtn">Exam</button><button onclick="AllScores()" id="allbtn">All</button></div>
          ...
          <div style="padding-left: 25px"><a href="clear_subject_result.php?subject=<?php echo $Subject; ?>&class=<?php echo $Class; ?>&term=<?php echo $Term; ?>&session=<?php echo $Session; ?>" ><button style="padding: 3px 3px 3px 3px; color: white; background: red"> Clear Subject Result</button></a></div>
          
        </ol>
        <ol class="breadcrumb">
            
          <div style="padding-left: 25px">
            <h5>VOICE VERIFICATION OPTION</h5>
            ...
            <label style="padding: 5px 5px 5px 5px;" for="all_voice">All </label><input type="radio" name="verifier" id="all_voice" onchange="SpeakOut('all Voice Verifier Activated')">
        </ol>

        <ol class="breadcrumb">
          
          <div style="background: lightgreen; width: 300px; float: left">
            Autofill Scores
            <table>
              <tr>
          ...
          <div style="background: lightgreen; width: 450px; float: left">
            Autofill Special Scores
            <table>
              <tr>
                <td><input type="text" name="txtToken" id="txtToken" placeholder="Token" style="background: blue; color:white; border: 2px solid black; width: 60px" value="<?php echo $classtoken; ?>" /></td>

                <td><select name="txtTypeSpecial" id="txtTypeSpecial" style="background: transparent; border: none"><option>ca1</option><option>ca2</option><option>ca3</option><option>exam</option></select></td>

                <td><textarea type="text" name="txtids" id="txtids" placeholder="Students e.g Seperate by (comma) ," style="background: blue; color:white; border: 2px solid black; width: 60px; width: 150px"></textarea></td>

                <td><input type="text" name="txtScoreSpecial" id="txtScoreSpecial" placeholder="Score" style="background: blue; color:white; border: 2px solid black; width: 60px"/></td>

                
                <td><button onclick="FillSpecialScore(document.getElementById('txtTypeSpecial').value,document.getElementById('txtToken').value,document.getElementById('txtids').value,'<?php echo $Subject; ?>','<?php echo $Session; ?>','<?php echo $Term; ?>','<?php echo $Class; ?>',document.getElementById('txtScoreSpecial').value);" >Update</button></td>
              </tr>
            </table>
          </div>
          <div style="background: lightgreen; width: 300px; float: right">
            Double Scores
            <table>
              <tr>
        ...
        <td style="border:none">
          <header>
                    ...
                    if(isset($_SESSION['lgina']) && $_SESSION['post']=="assistant headmistress" ||$_SESSION['post']=="assistant headmaster"||$_SESSION['post']=="webmaster" ||$_SESSION['post']=="exams & records")
                    {
                      ...
                      <td class="data" contenteditable="<?php echo $editStatus ?>" ondblclick="this.contentEditable=true;" id="<?php echo $RegNo; ?>ca2" onkeyup="validateca('<?php echo $RegNo; ?>');"
                          ...
                          onkeydown="if(event.keyCode==9){ 
                            ...
                            {
                              SpeakOut(document.getElementById('<?php echo $RegNo; ?>ca1').innerHTML+' '+document.getElementById('<?php echo $RegNo; ?>ca2').innerHTML+' '+document.getElementById('<?php echo $RegNo; ?>exam').innerHTML)
                            }
                           }"
            ...
            <table style="padding: 10px 10px 10px 10px; width: 100% " cellspacing="0">              
              ...
              <tr>
                <td style="text-align: center"><?php echo $subjectresultsummary['total_grade_A1'] ?></td>
                <td style="text-align: center"><?php echo $subjectresultsummary['total_grade_B2'] ?></td>
                <td style="text-align: center"><?php echo $subjectresultsummary['total_grade_B3'] ?></td>
                <td style="text-align: center"><?php echo $subjectresultsummary['total_grade_C4'] ?></td>
                <td style="text-align: center"><?php echo $subjectresultsummary['total_grade_C5'] ?></td>
                <td style="text-align: center"><?php echo $subjectresultsummary['total_grade_C6'] ?></td>
                <td style="text-align: center"><?php echo $subjectresultsummary['total_grade_D7'] ?></td>
                <td style="text-align: center"><?php echo $subjectresultsummary['total_grade_E8'] ?></td>
                <td style="text-align: center"><?php echo $subjectresultsummary['total_grade_F9'] ?></td></tr>
              <tr>
                <td colspan="2">High Score</td><td colspan="2" style="text-align: center"><?php echo $subjectresultsummary['high_score'] ?></td><td></td>
                <td colspan="2">Least Score</td><td colspan="2" style="text-align: center"><?php echo $subjectresultsummary['least_score'] ?></td></tr>
              <tr>
