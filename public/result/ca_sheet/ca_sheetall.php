...
foreach($Subjects as $Subject)
{
  ...
  foreach ($leasts as $least) {
    if(Module::IsStudentExist($least))
    {
  ...
  <title> <?php echo $Class; ?> <?php echo $Session; ?> <?php echo $Term; ?> Term Result Verifier</title>
              ...
              <table cellspacing="0" width="100%">
                ...
                <tbody>
                  ...
                  foreach($Students as $RegNo)
                  {
                    ...
                    <tr id="<?php echo $RegNo.$Subject;?>" onkeyup="Current('<?php echo $RegNo; ?>','<?php echo $Subject; ?>'); if(event.keyCode==9){
                      checkkey(event);validateca('<?php echo $RegNo; ?>','<?php echo $Subject; ?>');

                        computeresult('<?php echo $RegNo; ?>','<?php echo $Subject; ?>');

                        savescore('<?php echo $RegNo; ?>',
                            '<?php echo $Subject; ?>',
                           '<?php echo $Session; ?>',
                           '<?php echo $Term; ?>',
                           '<?php echo $Class; ?>');}" onkeydown="Current('<?php echo $RegNo; ?>','<?php echo $Subject; ?>'); if(event.keyCode==9){
                      checkkey(event);validateca('<?php echo $RegNo; ?>','<?php echo $Subject; ?>');
                      ...
                      <td width="200px"><?php echo $Student;?></td>
                        ...
                        ?>
                      <td class="data" style="<?php if ($cA1==0): ?>
                        background: red; color: black;
                      <?php endif ?>" contenteditable="<?php echo $editStatus; ?>" id="<?php echo $RegNo.$Subject; ?>ca1"  ><?php if($cA1>0){echo $cA1;}else{}  ?></td>
                      <td class="data" style="<?php if ($cA2==0): ?>
                        background: red; color: black;
                      <?php endif ?>" contenteditable="<?php echo $editStatus; ?>" id="<?php echo $RegNo.$Subject; ?>ca2"><?php  if($cA2>0){echo $cA2;}else{}  ?></td>
                      <td class="data" style="<?php if ($cA3==0): ?>
                        background: red; color: black;
                      <?php endif ?>" contenteditable="<?php echo $editStatus; ?>" id="<?php echo $RegNo.$Subject; ?>ca3"><?php  if($cA3>0){echo $cA3;}else{}  ?></td>
                      <td class="data" id="<?php echo $RegNo.$Subject; ?>caT"><?php echo $caTotal;  ?></td>
                      <td class="data" style="<?php if ($exam==0): ?>
                        background: red; color: black;
                      <?php endif ?>" contenteditable="<?php echo $editStatus; ?>"  id="<?php echo $RegNo.$Subject; ?>exam"><?php if($exam>0){echo $exam;}else{} ?></td>
                      <td class="data" id="<?php echo $RegNo.$Subject; ?>exT"><?php echo $ExTotal; ?></td>
                      <td class="data" id="<?php echo $RegNo.$Subject; ?>Pos"><?php echo $Position;
                        ...
                        ?></td>             
                      <td class="data" id="<?php echo $RegNo.$Subject; ?>Gr"><?php echo $Grade;  ?></td>
                      <td class="data" id="<?php echo $RegNo.$Subject; ?>Re"><?php echo $Remark;  ?></td>
                    </tr>
