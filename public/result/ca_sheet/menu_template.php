              ...
              <tbody>
                ...
                foreach($Students as $RegNo)
                {
                  ...
                  <tr id="<?php echo $RegNo;?>" onkeydown="Current(this.id); if(event.keyCode==9){
                    ...
                    {
                      ?>
                      <td ondblclick="DeRegisterResult('<?php echo $RegNo;?>', '<?php echo $Subject; ?>', '<?php echo $Session; ?>', '<?php echo $Term; ?>', '<?php echo $Class; ?>')" ><a style="background:transparent; border:none;" href="../dashboard/users/editstudentprofile.php?id=<?php echo $RegNo; ?>" title="Modify Profile"><center><?php echo $RegNo; ?></center></a></td>

                      <td ondblclick="DeRegisterResult('<?php echo $RegNo;?>', '<?php echo $Subject; ?>', '<?php echo $Session; ?>', '<?php echo $Term; ?>', '<?php echo $Class; ?>')"   onclick="togglePassport('<?php echo $RegNo;?>imgid')"><?php echo $Student; ?><a style="background:transparent; border:none;" href="../dashboard/users/changestudentpassport.php?id=<?php echo $RegNo; ?>" title="Change Picture"><img style="display: none" class="img-profile" src="<?php echo 'data:image/jpeg;base64,'.$studentDetails['passport'];?>" id="<?php echo $RegNo;?>imgid"></a></td>
                        <?php
                      }
                      else
                      {
