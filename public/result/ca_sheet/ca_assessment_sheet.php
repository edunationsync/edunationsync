...
{    
  ...
  <title> <?php echo $Class; ?> <?php echo $Session; ?> <?php echo $Term; ?> Term Full Assessment Sheet</title>
          ...
          <td style="border:none">
            <header>
              ...
              <div class="bheader"><center><b ><hd><?php echo strtoupper($school_details['school_name']); ?></hd></b><br/>
                <hd1><?php echo $Session; ?> <?php echo strtoupper($Term); ?> TERM  FULL ASSESSMENT SHEET <br/>FOR <?php echo strtoupper("$Class");  ?> SUBJECT: _________________________</hd1> <br/>
                <u>SCORE SHEET</u></center></div></b>
            </header>
              <table cellspacing="0" width="100%">
                
                <thead>
                <tr><td  width="40px"  valign="top">REG. NO.</td><td  valign="top" style="width: 300px">NAME</td>
                  <td width="5px" valign="top">Ass/Prj</td>
                  <td width="5px" valign="top">Cls wks/Prtn</td>
                  <td width="5px" valign="top">Att</td>
                  <td width="5px" valign="top">Note Chk</td>
                  <td width="5px" valign="top">CA1</td>
                  <td width="5px" valign="top">TOT</td>

                  <td width="5px" valign="top">Ass/Prj</td>
                  <td width="5px" valign="top">Cls wks/Prtn</td>
                  <td width="5px" valign="top">Att</td>
                  <td width="5px" valign="top">Note Chk</td>
                  <td width="5px" valign="top">CA2</td>
                  <td width="5px" valign="top">TOT</td>
                  ...
                  <td width="5px" valign="top">Att</td>
                  <td width="5px" valign="top">Note Chk</td>
                  <td width="5px" valign="top">CA3</td>
                  <td width="5px" valign="top">TOT</td>
                  <td  width="10px" valign="top">EXAM 70%</td>
                </tr></thead>
                <tbody>
                  <?php
                  ...
                  foreach($Students as $RegNo)
                  {
                    ...
                    <tr id="<?php echo $RegNo;?>" >
                       ...
                       <td width="200px" style="white-space: nowrap;"><?php echo $Student;?></td>
