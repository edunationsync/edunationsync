  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        <header>
            <b>
            <div class="bheader"><center ><img src="../images/school/logo.png" width="100px"><br/><b ><hd><?php echo strtoupper($school_details['school_name']); ?></hd></b><br/>SESSION SUBJECT RESULT SUMMARY SHEET <BR/>
                <?php echo $Session; ?> <?php echo strtoupper($Subject); ?> TERM FOR <?php echo strtoupper("$Class");  ?> </center></div></b>
          </header>
                  ...
                  <table cellspacing="0" width="100%">                    
                    ...
                    <tbody>
                      ...
                      foreach($Students as $RegNo)
                      {
                        ...
                        {
                          if(Analysis::ProcessSubjectResultAnalysisp($RegNo,$Class,$Session)){
                            echo "Success";
                          }
                          else{
                            echo "Fail";
                        ...
                        <tr>
                          ...
                          <td class="data" id="<?php echo $RegNo; ?>ca2Avr" ><?php echo $resAnalysis['ca2_average']; ?></td>
