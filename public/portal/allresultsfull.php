        ...
        <tr>
          ...
          <table width="95%" cellspacing="0" style="padding-top: 5px;">
            <tr>
              ...
              <td class="labelFieldHd" width="30px" >TOT CA1 (30)</td>
              <td class="labelFieldHd" width="30px" >AVER CA1 (100%)</td>
              <td class="labelFieldHd" width="30px" >TOT CA2 (30)</td>
              <td class="labelFieldHd" width="30px" >AVER CA2 (100%)</td>
              <td class="labelFieldHd" width="30px" >TOT CA3 (30)</td>
              <td class="labelFieldHd" width="30px" >AVER CA3 (100%)</td>
              <td class="labelFieldHd" width="30px" >CAT (90)</td>
              <td class="labelFieldHd" width="30px" >TOT EXAM (210)</td>
            ...
            foreach($Subjects as $Subject)
            {
              ...
              $subjectCount++;
                ...
                <tr>
                  ...
                  <td class="dataFieldBodyFirst" ><?php  echo $resultData['ca3_total'];  ?></td>
                  <td class="dataFieldBodyFirst" ><?php  echo $resultData['ca3_average'];  ?></td>
                  <td class="dataFieldBodyFirst" ><?php  echo $resultData['ca1_total']+$resultData['ca2_total']+$resultData['ca3_total']; ?></td>
            ...
            <tr>
                  ...
                  <td class="dataFieldBodyFirst" ></td>
                  <td class="dataFieldBodyFirst" ><?php  echo (Module::GetTotalCa3Scorep($student,$session,"First",$class)+Module::GetTotalCa3Scorep($student,$session,"Second",$class)+Module::GetTotalCa3Scorep($student,$session,"Third",$class) ) ?></td>
                  <td class="dataFieldBodyFirst" ></td>
