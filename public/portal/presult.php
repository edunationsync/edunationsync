...
$student=base64_decode($_GET['student']);
  ...
  <body>
    ...
    <div class="content" >
          ...
          <td width="90%" valign="top">
            ...
            <table width="95%" cellspacing="0" style="padding-top: 5px;">
              <tr>
                ...
                <td class="labelFieldHd" width="30px" >CA (30)</td>
              ...
              foreach($Subjects as $Subject)
              {
                ...
                $subjectCount++;
                  ...
                  ?>
                  <tr>
                    <td class="subjectFieldBody" style="font-size: 11px"><?php echo $subjectDetail['subject']; ?></td>
                    <td class="dataFieldBodyFirst" ><?php  echo round($resultData['ca1'],2);  ?></td>
                    <td class="dataFieldBodyFirst" ><?php  echo round($resultData['ca2'],2);  ?></td>
                    <td class="dataFieldBodyFirst" ><?php  echo round($resultData['ca3'],2);  ?></td>
                    <td class="dataFieldBodyFirst" ><?php  echo round($resultData['catotal'],2);  ?></td>
                    <td class="dataFieldBodyFirst" ><?php 
                    if(isset($resultData['exam'])) 
                      echo round($resultData['exam'],2);  
                    else
                      echo "-";
                    ...
                    if(isset($resultData['lowest_score'])) 
                      echo round($resultData['lowest_score'],2);  
                    else
                      echo "-";  ?></td>
                    <td class="dataFieldBodyFirst" ><?php 
                    if(isset($resultData['highest_score'])) 
                      echo round($resultData['highest_score'],2);  
                    else
                      echo "-";  ?></td>
                    <td class="dataFieldBodyFirst" ><?php  
      ...
      {
        ?>
        <div width="600px"><center><b>CUMULATIVE SUMMARY</b></center></div>

      <table width="600px" cellspacing="0" style="border: 2px">
        <tr>
          <?php
          foreach($Subjects as $Subject)
          {
            $subjectDetail=Module::ReadSubjectDetailsp($Subject);
            ?>
            <th style="background: green; color: white; font-weight: bolder; border: 1px solid black"><?php echo strtoupper($subjectDetail['short_code']); ?></th>
            <?php
          }
        ...
        <tr>
          ...
          foreach($Subjects as $Subject)
          {
            $resSubAnalysis=Analysis::ReadSessionSubjectResultAnalysisp($student,$Subject,$session);;
            ?>
            <th style=" border: 1px solid black"><?php echo round($resSubAnalysis['average'],2)  ?></th>
            <?php
       ...
       <div style="background: pink; padding: 4px 4px 4px 4px; width: 600px">Position Status: <span style="font-weight: bolder;" contenteditable="true">Promoted</span></div>
      ...
      <table width="100%">
        <tr>
          <td><br/><br/><a href="presult.php?session=<?php echo base64_encode($session);?>&class=<?php echo base64_encode($class);?>&term=<?php echo base64_encode($term);?>&student=<?php echo base64_encode($student);?>" target="_blank"><img src="../images/school/result_sign.jpg" style="float: right; width: 95%"></a></td>
        </tr>
        <tr>
