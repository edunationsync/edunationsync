...
<title><?php echo $school_details['school_name'];?> Admission</title>
<meta charset="utf-8">
			...
			<div class="row">
				<div class="col">
					<div class="section_title_container text-center">
						<h2 class="section_title">Its Time to Make Decision</h2>
						<div class="section_subtitle"><p>Before you enroll your child, please go through the following requirements to ensure that your child is due for the class you desire for him/her. The admission requirements for each of the clases are pointed below: </p></div>
					</div> 
				</div>
			</div>
			<div class="row features_row">
				...
				<div class="col-lg-3 feature_col">
					<div class="feature text-center trans_400">
						<h3 class="feature_title">Day Care/Prenuresry</h3>
						<ol>
							<li>_______</li>
							<li>_______</li>
							<li>_______</li>								
				...
				<div class="col-lg-3 feature_col">
					<div class="feature text-center trans_400">
						<h3 class="feature_title">Nursery One</h3>
						<ol>
							<li>_______</li>
							<li>_______</li>
							<li>_______</li>								
				...
				<div class="col-lg-3 feature_col">
					<div class="feature text-center trans_400">
						<h3 class="feature_title">Nursery Two</h3>
						<ol>
							<li>_______</li>
							<li>_______</li>
							<li>_______</li>								
				...
				<div class="col-lg-3 feature_col">
					<div class="feature text-center trans_400">
						<h3 class="feature_title">Basic One</h3>
						<ol>
							<li>_______</li>
							<li>_______</li>
							<li>_______</li>								
				...
				<div class="col-lg-3 feature_col">
					<div class="feature text-center trans_400">
						<h3 class="feature_title">Basic Two</h3>
						<ol>
							<li>_______</li>
							<li>_______</li>
							<li>_______</li>								
				...
				<div class="col-lg-3 feature_col">
					<div class="feature text-center trans_400">
						<h3 class="feature_title">Basic Three</h3>
						<ol>
							<li>_______</li>
							<li>_______</li>
							<li>_______</li>								
				...
				<div class="col-lg-3 feature_col">
					<div class="feature text-center trans_400">
						<h3 class="feature_title">Basic Four</h3>
						<ol>
							<li>_______</li>
							<li>_______</li>
							<li>_______</li>								
				...
				<div class="col-lg-3 feature_col">
					<div class="feature text-center trans_400">
						<h3 class="feature_title">Basic Five</h3>
						<ol>
							<li>_______</li>
							<li>_______</li>
							<li>_______</li>								
