...
<head> 
  ...
  <style type="text/css">
    ...
    <script type="text/javascript">
      ...
      function saveallocation(id,teacher,classs,subject,session,term,level)
      {
        var xmlhttp = new XMLHttpRequest();
        xmlhttp.onreadystatechange = function() {
          if (this.readyState == 4 && this.status == 200)
        ...
        xmlhttp.open("GET", "savesubjectallocation.php?id="+id+"&teacher="+teacher+"&classs="+classs+"&subject="+subject+"&session="+session+"&term="+term+"&level="+level
          , true);
        xmlhttp.send();
      }
      ...
      function deleteallocation(id)
      {
        ...
        xmlhttp.open("GET", "deletesubjectallocationp.php?id="+id
          , true);
        xmlhttp.send();
      }
        ...
        <ol class="breadcrumb">
          ...
          <div class="content">
            <table cellspacing="0" width="100%">
              <thead><tr><td valign='top'></td><td valign='top'>ID</td><td valign='top'>TEACHER</td><td   valign='top'>CLASS</td><td   valign='top'>SUBJECT</td><td   valign='top'>SESSION</td><td   valign='top'>TERM</td><td   valign='top'>LEVEL</td></tr></thead>
              <tbody>
                <?php
                $count=0;
                ...
                { 
                  ...
                  <td id="<?php echo $id;  ?>teache"  
                    saveallocation(id,teacher,classs,subject,session,term,level)
                    ...
                    <form method="POST" action="">
                      ...
                      <tr>
                        ...
                        <td class="form-label-group">
                          <select id="txtTeacher" name="txtTeacher" class="form-control" autofocus="true" required>
                        ...
                        <td class="form-label-group">
                          <select  name="txtClass" id="txtClass" class="form-control" onchange="loadsubjectitems(this.value)">
                              <?php
